...
FUNCTION get_estado_sv(ex_id_iniciativa_detalle NUMBER)
RETURN VARCHAR2
IS
    v_id_anho NUMBER;
    v_es_lider NUMBER;
    v_id_dexec NUMBER;
    v_id_paso_actual NUMBER;
    v_estado_sv VARCHAR2(4000); -- Aumentar el tamaño de la variable si es necesario
BEGIN
    -- Obtener datos de la iniciativa

    SELECT id_anho, es_lider, id_dexec
    INTO v_id_anho, v_es_lider, v_id_dexec
