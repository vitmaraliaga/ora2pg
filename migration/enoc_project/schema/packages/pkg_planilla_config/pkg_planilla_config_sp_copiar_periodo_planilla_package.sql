...
CREATE OR REPLACE PROCEDURE enoc.pkg_planilla_config_sp_copiar_periodo_planilla (P_ID_PERIODO_PLANILLA_ANT bigint, P_ID_PERIODO_PLANILLA bigint,P_ID_USER_REG bigint,P_ERROR OUT bigint, P_MSGERROR out text) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE enoc.pkg_planilla_config_sp_copiar_periodo_planilla (P_ID_PERIODO_PLANILLA_ANT bigint, P_ID_PERIODO_PLANILLA bigint,P_ID_USER_REG bigint,P_ERROR OUT bigint, P_MSGERROR out text) FROM PUBLIC;
