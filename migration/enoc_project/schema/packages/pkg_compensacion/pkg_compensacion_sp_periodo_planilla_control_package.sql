...
CREATE OR REPLACE PROCEDURE enoc.pkg_compensacion_sp_periodo_planilla_control (P_ID_ENTIDAD bigint, P_COD_MODULO text,P_ID_USER bigint,P_FECHA timestamp(0),P_TIPO_PER text,P_TIPO text, OUT CURSOR REFCURSOR ) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE enoc.pkg_compensacion_sp_periodo_planilla_control (P_ID_ENTIDAD bigint, P_COD_MODULO text,P_ID_USER bigint,P_FECHA timestamp(0),P_TIPO_PER text,P_TIPO text, OUT CURSOR REFCURSOR ) FROM PUBLIC;
