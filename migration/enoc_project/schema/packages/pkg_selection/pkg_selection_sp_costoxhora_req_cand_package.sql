...
CREATE OR REPLACE PROCEDURE enoc.pkg_selection_sp_costoxhora_req_cand (P_ID_SOLIC_REQ_CANDIDATO bigint,P_ID_SEMESTRE bigint,P_ID_USER bigint,P_ERROR OUT bigint,P_MSGERROR out text) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE enoc.pkg_selection_sp_costoxhora_req_cand (P_ID_SOLIC_REQ_CANDIDATO bigint,P_ID_SEMESTRE bigint,P_ID_USER bigint,P_ERROR OUT bigint,P_MSGERROR out text) FROM PUBLIC;
