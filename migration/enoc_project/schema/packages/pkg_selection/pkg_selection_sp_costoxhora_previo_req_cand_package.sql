...
CREATE OR REPLACE PROCEDURE enoc.pkg_selection_sp_costoxhora_previo_req_cand (P_ID_SOLIC_REQ_CANDIDATO bigint,P_ID_SEMESTRE bigint,P_ID_USER bigint,P_ERROR OUT bigint,P_MSGERROR out text) AS $body$
DECLARE
...
--             goto salida_previo;
      ...
      CALL pkg_selection_sp_costoxhora_req_cand_asin(P_ID_SOLIC_REQ_CANDIDATO,P_ID_SEMESTRE,l_fecha_finc,l_id_persona,l_fecha_inic,l_fecha_finc,l_error,l_msgerror);
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE enoc.pkg_selection_sp_costoxhora_previo_req_cand (P_ID_SOLIC_REQ_CANDIDATO bigint,P_ID_SEMESTRE bigint,P_ID_USER bigint,P_ERROR OUT bigint,P_MSGERROR out text) FROM PUBLIC;
