...
CREATE OR REPLACE FUNCTION enoc.fc_motivo_asist_docente (P_ID_TRABAJADOR bigint,P_ID_SEDEAREA bigint, P_DESDE_PROG timestamp(0),P_HASTA_PROG timestamp(0)) RETURNS varchar AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION enoc.fc_motivo_asist_docente (P_ID_TRABAJADOR bigint,P_ID_SEDEAREA bigint, P_DESDE_PROG timestamp(0),P_HASTA_PROG timestamp(0)) FROM PUBLIC;
