...
CREATE OR REPLACE VIEW vw_des_resultado_func_comp (id_participante, id_perfil_puesto_resp, id_grupo_competencia_nivel, id_modelo_evaluacion, id_desempeno_mod_eval, puntaje, porcentaje, id_desempeno, max_puntaje, descripcion, competencia, id_perfil_puesto) AS select 
a.ID_PARTICIPANTE,
a.ID_PERFIL_PUESTO_RESP,
a.ID_GRUPO_COMPETENCIA_NIVEL,
A.id_modelo_evaluacion,
M.ID_DESEMPENO_MOD_EVAL,
ROUND(avg(COALESCE(a.puntaje,0)),2) as puntaje,
a.porcentaje,
M.ID_DESEMPENO,
