...
CREATE OR REPLACE VIEW vw_solic_req_candidato_costo (id_item, id_solic_req_candidato, id_anho, id_mes, id_sedearea, id_programa_estudio, id_tipo_hora_pago, id_escala_sala_docente_det, id_semestre, dias, costohora, horas, importe, total, concepto, vigencia, siglas, mes, programa_estudio, semestre, area, id_entidad, id_depto, ccosto, ht_desde, ht_hasta, tipo_hora, cod_hora, id_nivel_ensenanza, id_modalidad_estudio, id_escala_sala_docente, id_area, id_user_reg, fecha_reg, id_user_mod, fecha_mod) AS SELECT
A.ID_ITEM,
...
A.ID_USER_MOD, 
A.FECHA_MOD
FROM ENOC.PLLA_SOLIC_REQ_CANDIDATO_COSTO A, 
ELISEO.CONTA_MES B, 
