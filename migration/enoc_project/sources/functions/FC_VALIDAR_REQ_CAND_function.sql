...
function                                                   FC_VALIDAR_REQ_CAND(P_ID_SOLIC_REQUE NUMBER,P_ID_PERSONA NUMBER) RETURN varchar2
IS
l_contar number:=0;
l_msg varchar(600):='0';
...
BEGIN
    ...
    into l_tipo_tiempo_trabajo,l_id_modalidad_req,l_esdocente,l_id_entidad
    ...
    case 
        ...
        when l_codigo_mod in('CE','CES','IN') then 
          ...
          if l_codigo_mod='CES' then  --debe ser alumo
            ...
            select COUNT(1) INTO l_contar from   "DAVID"."ACAD_ALUMNO_PLAN" a, "DAVID"."ACAD_PLAN_PROGRAMA" b, "DAVID"."ACAD_PROGRAMA_ESTUDIO" C
