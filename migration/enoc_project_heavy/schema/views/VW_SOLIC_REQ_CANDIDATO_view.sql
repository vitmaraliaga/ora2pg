...
CASE WHEN s.ID_TIPO_TIEMPO_TRABAJO=3 THEN 'S/. '||A.SUELDO_SUGERIDO::text ELSE '' END AS COSTO_HORA,
CASE WHEN s.ID_TIPO_TIEMPO_TRABAJO<>3 THEN 'S/. '||A.SUELDO_SUGERIDO::text ELSE '' END AS SUELDO,
