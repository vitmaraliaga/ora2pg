...
(SELECT X.DIRECCION FROM MOISES.PERSONA_DIRECCION X WHERE X.ID_PERSONA=A.ID_PERSONA AND X.ID_TIPODIRECCION=4 AND (X.ID_TIPOVIA IS NOT NULL AND X.ID_TIPOVIA::text <> '') AND X.ES_ACTIVO=1   LIMIT 1) AS DOMICILIO,
PP.TIPO_ASIGNAR,
