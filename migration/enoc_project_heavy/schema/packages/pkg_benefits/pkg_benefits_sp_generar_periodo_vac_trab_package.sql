...
CREATE OR REPLACE PROCEDURE enoc.pkg_benefits_sp_generar_periodo_vac_trab (P_ID_TRABAJADOR bigint, P_ID_PERIODO_VAC bigint,P_ITEM bigint,P_ERROR OUT bigint,P_MSGERROR out text) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE enoc.pkg_benefits_sp_generar_periodo_vac_trab (P_ID_TRABAJADOR bigint, P_ID_PERIODO_VAC bigint,P_ITEM bigint,P_ERROR OUT bigint,P_MSGERROR out text) FROM PUBLIC;
