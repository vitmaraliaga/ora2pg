...
CREATE OR REPLACE PROCEDURE enoc.pkg_planilla_config_sp_generar_tramo_ingreso (P_ID_ANHO bigint,P_ID_USER bigint) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE enoc.pkg_planilla_config_sp_generar_tramo_ingreso (P_ID_ANHO bigint,P_ID_USER bigint) FROM PUBLIC;
