...
CREATE OR REPLACE PROCEDURE enoc.pkg_contract_sp_costoxhora_previo_asin (P_ID_CONTRATO bigint,P_ID_SEMESTRE bigint,P_FECHA_PAGO timestamp(0),P_ID_PERSONA bigint,P_INICIO timestamp(0), P_FIN timestamp(0),P_ERROR OUT bigint,P_MSGERROR out text) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE enoc.pkg_contract_sp_costoxhora_previo_asin (P_ID_CONTRATO bigint,P_ID_SEMESTRE bigint,P_FECHA_PAGO timestamp(0),P_ID_PERSONA bigint,P_INICIO timestamp(0), P_FIN timestamp(0),P_ERROR OUT bigint,P_MSGERROR out text) FROM PUBLIC;
