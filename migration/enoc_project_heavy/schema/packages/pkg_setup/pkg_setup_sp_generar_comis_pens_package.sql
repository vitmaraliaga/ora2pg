...
CREATE OR REPLACE PROCEDURE enoc.pkg_setup_sp_generar_comis_pens (P_ID_ANHO bigint, P_ID_MES bigint,P_ID_USER bigint) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE enoc.pkg_setup_sp_generar_comis_pens (P_ID_ANHO bigint, P_ID_MES bigint,P_ID_USER bigint) FROM PUBLIC;
