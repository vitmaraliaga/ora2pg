...
CREATE OR REPLACE PROCEDURE eliseo.spc_bi_saldo_departamentos ( p_id_entidad integer, p_id_anho integer, OUT CURSOR REFCURSOR ) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE eliseo.spc_bi_saldo_departamentos ( p_id_entidad integer, p_id_anho integer, OUT CURSOR REFCURSOR ) FROM PUBLIC;
