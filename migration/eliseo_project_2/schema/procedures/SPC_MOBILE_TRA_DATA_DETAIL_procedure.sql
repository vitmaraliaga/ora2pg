...
CREATE OR REPLACE PROCEDURE eliseo.spc_mobile_tra_data_detail ( p_id_entidad integer, p_id_anho integer, p_id_ctacte integer, OUT CURSOR REFCURSOR ) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE eliseo.spc_mobile_tra_data_detail ( p_id_entidad integer, p_id_anho integer, p_id_ctacte integer, OUT CURSOR REFCURSOR ) FROM PUBLIC;
