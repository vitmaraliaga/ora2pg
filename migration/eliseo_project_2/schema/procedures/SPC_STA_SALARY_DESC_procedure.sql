...
CREATE OR REPLACE PROCEDURE eliseo.spc_sta_salary_desc ( p_id_entidad integer, p_id_anho integer, p_id_mes integer, p_id_persona integer, p_tipo text, OUT CURSOR REFCURSOR ) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE eliseo.spc_sta_salary_desc ( p_id_entidad integer, p_id_anho integer, p_id_mes integer, p_id_persona integer, p_tipo text, OUT CURSOR REFCURSOR ) FROM PUBLIC;
