...
CREATE OR REPLACE PROCEDURE eliseo.spc_sta_salary_ing_ctipo ( p_id_entidad integer, p_id_anho integer, p_id_mes integer, p_id_persona integer, p_tipo text, p_id_ctacte text, --add 
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE eliseo.spc_sta_salary_ing_ctipo ( p_id_entidad integer, p_id_anho integer, p_id_mes integer, p_id_persona integer, p_tipo text, p_id_ctacte text, p_id_cuentaaasi text, p_dc text, OUT CURSOR REFCURSOR ) FROM PUBLIC;
