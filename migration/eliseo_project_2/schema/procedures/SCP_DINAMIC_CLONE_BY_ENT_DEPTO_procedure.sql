...
CREATE OR REPLACE PROCEDURE eliseo.scp_dinamic_clone_by_ent_depto ( v_ID_ENTIDAD_FROM bigint, v_ID_DEPTO_FROM text, v_ID_YEAR_FROM bigint, v_ID_ENTIDAD_TO bigint, v_ID_DEPTO_TO text, v_ID_YEAR_TO bigint, v_ERROR OUT bigint, v_MSGERROR OUT text ) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE eliseo.scp_dinamic_clone_by_ent_depto ( v_ID_ENTIDAD_FROM bigint, v_ID_DEPTO_FROM text, v_ID_YEAR_FROM bigint, v_ID_ENTIDAD_TO bigint, v_ID_DEPTO_TO text, v_ID_YEAR_TO bigint, v_ERROR OUT bigint, v_MSGERROR OUT text ) FROM PUBLIC;
