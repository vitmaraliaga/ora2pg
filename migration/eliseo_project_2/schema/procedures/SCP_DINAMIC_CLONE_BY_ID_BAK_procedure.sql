...
CREATE OR REPLACE PROCEDURE eliseo.scp_dinamic_clone_by_id_bak ( v_ID_DINAMICA bigint, v_ID_YEAR_TO bigint, v_ERROR OUT bigint, v_MSGERROR OUT text ) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE eliseo.scp_dinamic_clone_by_id_bak ( v_ID_DINAMICA bigint, v_ID_YEAR_TO bigint, v_ERROR OUT bigint, v_MSGERROR OUT text ) FROM PUBLIC;
