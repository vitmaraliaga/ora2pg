...
CREATE OR REPLACE PROCEDURE eliseo.sp_anular_ventas_reg (P_ID_VENTA bigint, P_ID_PERSONA bigint, P_MOTIVO text, P_ERROR OUT bigint, P_MSGERROR OUT text) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE eliseo.sp_anular_ventas_reg (P_ID_VENTA bigint, P_ID_PERSONA bigint, P_MOTIVO text, P_ERROR OUT bigint, P_MSGERROR OUT text) FROM PUBLIC;
