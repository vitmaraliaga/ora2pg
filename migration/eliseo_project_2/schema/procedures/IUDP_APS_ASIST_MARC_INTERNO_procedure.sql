...
CREATE OR REPLACE PROCEDURE eliseo.iudp_aps_asist_marc_interno ( v_ICODUSUARIO bigint, v_ID_ENTIDAD bigint, v_FECHA timestamp(0), v_HORARIOENTRADA timestamp(0), v_HORARIOSALIDA timestamp(0), v_INICIOREFRIGERIO timestamp(0), v_FINREFRIGERIO timestamp(0) ) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE eliseo.iudp_aps_asist_marc_interno ( v_ICODUSUARIO bigint, v_ID_ENTIDAD bigint, v_FECHA timestamp(0), v_HORARIOENTRADA timestamp(0), v_HORARIOSALIDA timestamp(0), v_INICIOREFRIGERIO timestamp(0), v_FINREFRIGERIO timestamp(0) ) FROM PUBLIC;
