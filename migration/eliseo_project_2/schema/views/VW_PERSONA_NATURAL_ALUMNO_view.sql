...
CREATE OR REPLACE VIEW vw_persona_natural_alumno (id_persona, id_erp, paterno, materno, nombre, sexo, fec_nacimiento, nom_persona, id_tipodocumento, num_documento, codigo) AS SELECT Persona.ID_PERSONA,
...
INNER JOIN moises.Persona_Natural_Alumno
