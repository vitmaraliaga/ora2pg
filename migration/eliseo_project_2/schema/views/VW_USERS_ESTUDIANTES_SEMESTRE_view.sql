...
pa.pais country,coalesce(aac.Fecha_Actualizacion,aac.Fecha_Registro) creation_date,
...
aac.sede locality,pd.Direccion postal_address,CASE WHEN aac.id_sede=1 THEN 'Lima' WHEN aac.id_sede=2 THEN 'Puno' WHEN aac.id_sede=3 THEN 'San Martìn' END  region,
