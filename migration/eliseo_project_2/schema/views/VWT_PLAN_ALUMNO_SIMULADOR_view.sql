...
CREATE OR REPLACE VIEW vwt_plan_alumno_simulador (id_escuela, id_persona, codigo, alumno, sexo, sede, nombre_facultad, nombre_escuela, modalidad_estudio, id_modalidad_estudio) AS select  d.ID_ESCUELA,a.ID_PERSONA,eliseo.FC_CODIGO_ALUMNO(a.ID_PERSONA)CODIGO,ELISEO.FC_NOMBRE_CLIENTE(a.ID_PERSONA) AS ALUMNO,CASE WHEN e.sexo='1' THEN 'M' WHEN e.sexo='2' THEN 'F' END  AS SEXO,
        d.SEDE,
        d.NOMBRE_FACULTAD,
        d.NOMBRE_ESCUELA,
        d.MODALIDAD_ESTUDIO,
