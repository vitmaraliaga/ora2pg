...
CREATE OR REPLACE PROCEDURE eliseo.pkg_sales_school_sp_venta_cargar_pension ( P_IMPORTES text, P_IDS_ARTICULOS text, P_ID_PERSONA bigint, P_ID_ENTIDAD bigint,P_ID_DEPTO text,P_ID_ANHO bigint, P_ID_MES bigint,P_ID_CLIENTE bigint,P_ID_CLIENTE_LEGAL bigint, P_ID_COMPROBANTE text, P_ID_MONEDA bigint,  -- moneda de venta 
...
--                     GOTO salida_rapida;
        ...
        IF L_ID_VENTA <> 0 THEN 
            RAISE NOTICE 'finalizar L_ID_VENTA = %', L_ID_VENTA;
