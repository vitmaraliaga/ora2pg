...
CREATE OR REPLACE PROCEDURE eliseo.pkg_sales_school_sp_obtener_serie_numero (P_ID_PERSONA bigint,P_ID_COMPROBANTE text,P_ID_ENTIDAD bigint ,P_ID_DEPTO text ,P_SERIE OUT text,P_NUMERO OUT bigint) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE eliseo.pkg_sales_school_sp_obtener_serie_numero (P_ID_PERSONA bigint,P_ID_COMPROBANTE text,P_ID_ENTIDAD bigint ,P_ID_DEPTO text ,P_SERIE OUT text,P_NUMERO OUT bigint) FROM PUBLIC;
