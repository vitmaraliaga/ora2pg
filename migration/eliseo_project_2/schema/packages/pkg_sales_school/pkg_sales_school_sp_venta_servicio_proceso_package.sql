...
CREATE OR REPLACE PROCEDURE eliseo.pkg_sales_school_sp_venta_servicio_proceso ( P_IDS_VENTA text, P_IMPORTES text, P_IDS_SERVICIOS text, P_ID_PERSONA bigint, P_ID_ENTIDAD bigint,P_ID_DEPTO text,P_ID_ANHO bigint, P_ID_MES bigint,P_ID_CLIENTE bigint,P_ID_CLIENTE_LEGAL bigint, P_ID_COMPROBANTE text, P_EFECTIVO bigint, P_TARJETA bigint, P_ID_TIPO_TARJETA bigint, P_OPERACION text, P_ID_MONEDA bigint, P_ID_DEPOSITO_EFECTIVO OUT bigint, P_ID_DEPOSITO_TARJETA OUT bigint, P_ID_VENTA OUT bigint, P_COUNT_ID_VENTA_OLD OUT bigint, P_ERROR OUT bigint,P_MSGERROR OUT text) AS $body$
DECLARE
...
BEGIN
        ...
        select eliseo.FC_SPLIT(P_IDS_SERVICIOS,'|') into STRICT s_servicios;
        -- 1.- Validaciones
        SELECT
...
--                 GOTO salida_rapida;
        ...
        then
            ...
            pkg_sales_school_sp_serv_creact_venta(
...
--                 GOTO salida_rapida;
            ...
            LOOP
                ...
                select cast(s_servicios(i) as bigint) into STRICT s_id_servicio;
                if s_id_venta = 0
                then
                    /*pkg_sales_school_sp_crear_venta_detalle(L_ID_VENTA, s_importe, s_id_articulo,
                                            ...
                                            L_ERROR,L_MSGERROR);
                    */
                    pkg_sales_school_sp_serv_creact_venta_detalle(
...
--                         GOTO salida_rapida;
        ...
        SELECT max(ID_ARTICULO) into STRICT s_id_articulo FROM CAJA_SERVICIO cs WHERE ID_SERVICIO = s_id_servicio;
...
--             <<end_loop>>
        ...
        IF L_ID_VENTA <> 0 THEN 
            ...
            -- pkg_sales_sp_serv_finalizar_venta(L_ID_VENTA, P_ID_PERSONA, :P_EFECTIVO, :P_TARJETA, :P_ID_TIPOTARJETA, :P_OPERACION, :P_ERROR, :P_MSGERROR); 
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE eliseo.pkg_sales_school_sp_venta_servicio_proceso ( P_IDS_VENTA text, P_IMPORTES text, P_IDS_SERVICIOS text, P_ID_PERSONA bigint, P_ID_ENTIDAD bigint,P_ID_DEPTO text,P_ID_ANHO bigint, P_ID_MES bigint,P_ID_CLIENTE bigint,P_ID_CLIENTE_LEGAL bigint, P_ID_COMPROBANTE text, P_EFECTIVO bigint, P_TARJETA bigint, P_ID_TIPO_TARJETA bigint, P_OPERACION text, P_ID_MONEDA bigint, P_ID_DEPOSITO_EFECTIVO OUT bigint, P_ID_DEPOSITO_TARJETA OUT bigint, P_ID_VENTA OUT bigint, P_COUNT_ID_VENTA_OLD OUT bigint, P_ERROR OUT bigint,P_MSGERROR OUT text) FROM PUBLIC;
