...
CREATE OR REPLACE PROCEDURE eliseo.pkg_sales_school_sp_serv_creact_venta_detalle (P_ID_VENTA bigint,P_ID_SERVICIO bigint,P_CANTIDAD bigint,P_ID_VDETALLE INOUT bigint, P_ERROR OUT bigint,P_MSGERROR OUT text) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE eliseo.pkg_sales_school_sp_serv_creact_venta_detalle (P_ID_VENTA bigint,P_ID_SERVICIO bigint,P_CANTIDAD bigint,P_ID_VDETALLE INOUT bigint, P_ERROR OUT bigint,P_MSGERROR OUT text) FROM PUBLIC;
