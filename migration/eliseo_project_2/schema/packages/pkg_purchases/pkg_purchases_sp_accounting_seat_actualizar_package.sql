...
CREATE OR REPLACE PROCEDURE eliseo.pkg_purchases_sp_accounting_seat_actualizar ( P_ID_FONDO bigint, P_ID_DEPTO text, P_ID_CUENTAAASI text, P_ID_RESTRICCION text, P_ID_CTACTE text, P_IMPORTE bigint, P_IS_DC text, P_DESCRIPCION text, P_ID_COMPRA bigint, P_ERROR OUT bigint, P_ID_CASIENTO INOUT bigint ) AS $body$
DECLARE
...
BEGIN
        ...
        DC = L_DC,
        FECHA_ACTUALIZACION = statement_timestamp()
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE eliseo.pkg_purchases_sp_accounting_seat_actualizar ( P_ID_FONDO bigint, P_ID_DEPTO text, P_ID_CUENTAAASI text, P_ID_RESTRICCION text, P_ID_CTACTE text, P_IMPORTE bigint, P_IS_DC text, P_DESCRIPCION text, P_ID_COMPRA bigint, P_ERROR OUT bigint, P_ID_CASIENTO INOUT bigint ) FROM PUBLIC;
