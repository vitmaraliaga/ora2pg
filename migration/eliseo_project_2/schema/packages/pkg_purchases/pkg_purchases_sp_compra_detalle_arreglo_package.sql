...
CREATE OR REPLACE PROCEDURE eliseo.pkg_purchases_sp_compra_detalle_arreglo (P_ID_COMPRA bigint,P_ID_DETALLE bigint,P_CANTIDAD bigint,P_BASE bigint,P_IGV bigint,P_IMPORTE bigint, P_ID_CTIPOIGV bigint DEFAULT NULL) AS $body$
DECLARE

        L_ID_CTIPOIGV varchar(2);
        L_PRECIO decimal(10,3);
        L_BASE decimal(10,3);
        L_IGV decimal(10,3);
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE eliseo.pkg_purchases_sp_compra_detalle_arreglo (P_ID_COMPRA bigint,P_ID_DETALLE bigint,P_CANTIDAD bigint,P_BASE bigint,P_IGV bigint,P_IMPORTE bigint, P_ID_CTIPOIGV bigint DEFAULT NULL) FROM PUBLIC;
