...
DECLARE
        ...
        L_IMPORTE_RETENER decimal(10,2);
...
UNION ALL
        ...
        --B.ID_TIPOPLAN,B.ID_CUENTAAASI,B.ID_RESTRICCION,B.ID_FONDO,B.ID_CTACTE,B.ID_DEPTO,B.DC,SUM(B.PORCENTAJE)/L_CONT AS PORCENTAJE,B.GLOSA,B.INDICADOR,NVL(B.NRO_ASIENTO,1) AS NRO_ASIENTO
         B.ID_TIPOPLAN,B.ID_CUENTAAASI,B.ID_RESTRICCION,B.ID_FONDO,B.ID_CTACTE,B.ID_DEPTO,B.DC,SUM(B.PORCENTAJE) AS PORCENTAJE,B.GLOSA,B.INDICADOR,coalesce(B.NRO_ASIENTO,1) AS NRO_ASIENTO
...
BEGIN
        ...
        IF P_ERROR = 0 THEN
            SELECT ID_ENTIDAD,ID_PROVEEDOR,SERIE,NUMERO,BASE,IGV,IMPORTE,IMPORTE_ME,coalesce(IMPORTE_RENTA,0),ESTADO INTO STRICT L_ID_ENTIDAD,L_ID_PROVEEDOR,L_SERIE,L_NUMERO,L_BASE, L_IGV, L_IMPORTE, L_IMPORTE_ME, L_IMPORTE_RETENER, L_ESTADO  FROM COMPRA WHERE ID_COMPRA = P_ID_COMPRA;
            IF L_ESTADO <> '1' THEN
