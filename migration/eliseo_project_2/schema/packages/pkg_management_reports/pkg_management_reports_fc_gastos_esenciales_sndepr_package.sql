...
CREATE OR REPLACE FUNCTION eliseo.pkg_management_reports_fc_gastos_esenciales_sndepr (P_ID_ENTIDAD bigint,P_ID_ANHO bigint, P_ID_MES bigint) RETURNS bigint AS $body$
DECLARE
...
UNION ALL
						                                ...
						                                GROUP BY GAOP.ID_ANHO,GAOP.ID_MES) alias74       
						                            GROUP BY ID_ANHO,ID_MES
						                            ) alias75 
						                    GROUP BY ID_ANHO,ID_MES
						                    ) alias76
...
UNION ALL
						                ...
						                ) alias218 GROUP BY ID_ANHO,ID_MES
						               )GA;
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION eliseo.pkg_management_reports_fc_gastos_esenciales_sndepr (P_ID_ENTIDAD bigint,P_ID_ANHO bigint, P_ID_MES bigint) FROM PUBLIC;
