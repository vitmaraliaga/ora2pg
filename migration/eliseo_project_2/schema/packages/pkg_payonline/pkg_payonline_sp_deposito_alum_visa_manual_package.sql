...
CREATE OR REPLACE PROCEDURE eliseo.pkg_payonline_sp_deposito_alum_visa_manual ( P_ID_PERSONA bigint, P_OPERACION text, P_ID_ENTIDAD bigint, P_ID_DEPTO text, P_IMPORTE bigint, P_FECHA_OP timestamp(0), P_IP text, P_ID_DINAMICA bigint, P_COD_TARJETA text, P_ID_ORIGEN text, P_ID OUT text, P_ERROR OUT bigint, P_MSGERROR out text) AS $body$
DECLARE
...
LANGUAGE PLPGSQL
;
-- REVOKE ALL ON PROCEDURE eliseo.pkg_payonline_sp_deposito_alum_visa_manual ( P_ID_PERSONA bigint, P_OPERACION text, P_ID_ENTIDAD bigint, P_ID_DEPTO text, P_IMPORTE bigint, P_FECHA_OP timestamp(0), P_IP text, P_ID_DINAMICA bigint, P_COD_TARJETA text, P_ID_ORIGEN text, P_ID OUT text, P_ERROR OUT bigint, P_MSGERROR out text) FROM PUBLIC;
