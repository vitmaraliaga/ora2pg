...
CREATE OR REPLACE PROCEDURE eliseo.pkg_sales_sp_crear_actualizar_trans (P_ID_ENTIDAD bigint,P_ID_DEPTO text,P_ID_ANHO bigint,P_ID_MES bigint,P_ID_PERSONA bigint, P_ID_EMPLEADO bigint,P_ID_CLIENTE bigint,P_ID_VENTA bigint,P_ID_VDETALLE bigint,P_IMPORTE bigint,P_DC text, P_ID_TIPOTRANSACCION bigint,P_ID_DINAMICA bigint,P_GLOSA text, P_ID_TRANSFERENCIA INOUT bigint,P_ERROR OUT bigint, P_MSGERROR OUT text) AS $body$
DECLARE
...
--                 GOTO salida_rapida;
            ...
            l_contar := pkg_sales_fc_verificar_serie_numero(P_ID_PERSONA,'00',P_ID_ENTIDAD, P_ID_DEPTO);
            if l_contar < 1 then
                l_error := 1;
...
--                 GOTO salida_rapida;
            ...
            IF l_error = 0 then
                ...
                CALL pkg_sales_sp_generar_asiento_trans(L_ID_TRANSFERENCIA,l_error,l_msgerror);
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE eliseo.pkg_sales_sp_crear_actualizar_trans (P_ID_ENTIDAD bigint,P_ID_DEPTO text,P_ID_ANHO bigint,P_ID_MES bigint,P_ID_PERSONA bigint, P_ID_EMPLEADO bigint,P_ID_CLIENTE bigint,P_ID_VENTA bigint,P_ID_VDETALLE bigint,P_IMPORTE bigint,P_DC text, P_ID_TIPOTRANSACCION bigint,P_ID_DINAMICA bigint,P_GLOSA text, P_ID_TRANSFERENCIA INOUT bigint,P_ERROR OUT bigint, P_MSGERROR OUT text) FROM PUBLIC;
