...
CREATE OR REPLACE PROCEDURE eliseo.pkg_sales_sp_crear_venta_detalle_inven (P_ID_VENTA bigint,P_ID_ARTICULO text,P_ID_ALMACEN bigint,P_CANTIDAD bigint,P_ERROR OUT bigint,P_MSGERROR out text) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE eliseo.pkg_sales_sp_crear_venta_detalle_inven (P_ID_VENTA bigint,P_ID_ARTICULO text,P_ID_ALMACEN bigint,P_CANTIDAD bigint,P_ERROR OUT bigint,P_MSGERROR out text) FROM PUBLIC;
