...
CREATE OR REPLACE PROCEDURE eliseo.pkg_sales_sp_generar_asiento_trans (P_ID_TRANSFERENCIA bigint, P_ERROR OUT bigint,P_MSGERROR out text) AS $body$
DECLARE
...
;
                ...
                if l_unico='U' then
                    ...
                    select pkg_sales_fc_depto_cliente_colegios(l_id_cliente) into STRICT l_depto;
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE eliseo.pkg_sales_sp_generar_asiento_trans (P_ID_TRANSFERENCIA bigint, P_ERROR OUT bigint,P_MSGERROR out text) FROM PUBLIC;
