...
CREATE OR REPLACE PROCEDURE eliseo.pkg_sales_sp_update_precios (P_ID_ALMACEN bigint,P_ID_ANHO bigint,P_ID_ARTICULO bigint, P_PRECIO bigint, P_DESCUENTO bigint, P_ERROR OUT bigint,P_MSGERROR out text) AS $body$
DECLARE
...
BEGIN
            ...
            UPDATE VENTA_PRECIO SET COSTO = round((P_PRECIO/L_BI)::numeric,2),
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE eliseo.pkg_sales_sp_update_precios (P_ID_ALMACEN bigint,P_ID_ANHO bigint,P_ID_ARTICULO bigint, P_PRECIO bigint, P_DESCUENTO bigint, P_ERROR OUT bigint,P_MSGERROR out text) FROM PUBLIC;
