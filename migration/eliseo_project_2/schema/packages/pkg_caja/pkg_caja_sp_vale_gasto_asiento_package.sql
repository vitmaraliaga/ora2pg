...
CREATE OR REPLACE PROCEDURE eliseo.pkg_caja_sp_vale_gasto_asiento (P_ID_VGASTO bigint,P_ID_DINAMICA bigint,P_ERROR OUT bigint,P_MSGERROR OUT text) AS $body$
DECLARE
...
;
                ...
                SELECT IMPORTE,IMPORTE_ME INTO STRICT L_IMPORTEASIENTO,L_IMPORTEASIENTO_ME  FROM CAJA_VALE_GASTO WHERE ID_VGASTO = P_ID_VGASTO;
                ...
                IF L_IMPORTEASIENTO<>0 THEN
                    ...
                    SELECT coalesce(MAX(ID_VASIENTO),0)+1 INTO STRICT L_ID_CASIENTO FROM CAJA_VALE_GASTO_ASIENTO;
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE eliseo.pkg_caja_sp_vale_gasto_asiento (P_ID_VGASTO bigint,P_ID_DINAMICA bigint,P_ERROR OUT bigint,P_MSGERROR OUT text) FROM PUBLIC;
