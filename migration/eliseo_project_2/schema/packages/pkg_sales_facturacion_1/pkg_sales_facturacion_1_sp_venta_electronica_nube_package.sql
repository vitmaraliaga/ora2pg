...
CREATE OR REPLACE PROCEDURE eliseo.pkg_sales_facturacion_1_sp_venta_electronica_nube (P_ID_VENTA bigint) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE eliseo.pkg_sales_facturacion_1_sp_venta_electronica_nube (P_ID_VENTA bigint) FROM PUBLIC;
