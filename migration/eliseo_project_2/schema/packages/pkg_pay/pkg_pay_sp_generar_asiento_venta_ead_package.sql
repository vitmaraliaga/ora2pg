...
CREATE OR REPLACE PROCEDURE eliseo.pkg_pay_sp_generar_asiento_venta_ead (P_ID_VENTA bigint, P_ERROR OUT bigint,P_MSGERROR out text) AS $body$
DECLARE
...
BEGIN
      ...
      FROM VENTA_DETALLE
      WHERE ID_VENTA=P_ID_VENTA
      and coalesce(ID_DEPTO_ASI::text, '') = '';
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE eliseo.pkg_pay_sp_generar_asiento_venta_ead (P_ID_VENTA bigint, P_ERROR OUT bigint,P_MSGERROR out text) FROM PUBLIC;
