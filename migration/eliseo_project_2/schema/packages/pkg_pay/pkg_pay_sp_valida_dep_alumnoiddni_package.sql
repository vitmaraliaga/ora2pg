...
CREATE OR REPLACE PROCEDURE eliseo.pkg_pay_sp_valida_dep_alumnoiddni ( P_ID_ENTIDAD bigint, P_ID_DEPTO text, P_ID_DINAMICA bigint, P_ID_COMPROBANTE text, P_ID_ANHO bigint, P_ID_MES bigint, P_ID_PERSONA bigint, P_ERROR OUT bigint, P_MSGERROR out text ) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE eliseo.pkg_pay_sp_valida_dep_alumnoiddni ( P_ID_ENTIDAD bigint, P_ID_DEPTO text, P_ID_DINAMICA bigint, P_ID_COMPROBANTE text, P_ID_ANHO bigint, P_ID_MES bigint, P_ID_PERSONA bigint, P_ERROR OUT bigint, P_MSGERROR out text ) FROM PUBLIC;
