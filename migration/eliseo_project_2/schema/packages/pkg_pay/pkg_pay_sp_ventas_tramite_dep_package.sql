...
CREATE OR REPLACE PROCEDURE eliseo.pkg_pay_sp_ventas_tramite_dep ( P_ID_ORDEN bigint, P_IMPORTE bigint, P_IP text, P_ID OUT text, P_ERROR OUT bigint, P_MSGERROR out text ) AS $body$
DECLARE
...
BEGIN
        ...
        ID_VENTA=(l_ventas)::numeric ,
        PAGADO=1
       where ID_TRAMITE_PAGO=(P_ID_ORIGEN)::numeric;

        select 
        ID_CLIENTE_LEGAL INTO STRICT P_ID_CLIENTE
...
--               GOTO salida_tramite;
        ...
        CALL pkg_pay_sp_ventas_tramite(
                 P_ID_PERSONA,	
                 P_OPERACION,
                 P_ID_ENTIDAD,
                 P_ID_DEPTO,
...
--               GOTO salida_tramite;
        ...
        where ID_TRAMITE_PAGO=(P_ID_ORIGEN)::numeric   LIMIT 1;
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE eliseo.pkg_pay_sp_ventas_tramite_dep ( P_ID_ORDEN bigint, P_IMPORTE bigint, P_IP text, P_ID OUT text, P_ERROR OUT bigint, P_MSGERROR out text ) FROM PUBLIC;
