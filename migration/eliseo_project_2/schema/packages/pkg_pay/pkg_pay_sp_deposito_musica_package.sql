...
CREATE OR REPLACE PROCEDURE eliseo.pkg_pay_sp_deposito_musica ( P_ID_ORDEN bigint, P_IMPORTE bigint, P_IP text, P_ID OUT text, P_ERROR OUT bigint, P_MSGERROR out text ) AS $body$
DECLARE
...
--               GOTO salida_depalumniddni;
        ...
        INSERT INTO FIN_ALUMNO_MUSICA(ID_PERSONA,ID_VENTA,FECHA)VALUES (P_ID_PERSONA,(l_ventas)::numeric ,clock_timestamp());
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE eliseo.pkg_pay_sp_deposito_musica ( P_ID_ORDEN bigint, P_IMPORTE bigint, P_IP text, P_ID OUT text, P_ERROR OUT bigint, P_MSGERROR out text ) FROM PUBLIC;
