...
CREATE OR REPLACE PROCEDURE eliseo.pkg_pay_sp_deposito_alumno_visa_acad ( P_ID_ORDEN bigint, P_IMPORTE bigint, P_IP text, P_ID OUT text, P_ERROR OUT bigint, P_MSGERROR out text ) AS $body$
DECLARE
...
--                 GOTO salida_depalumniddni;
            ...
            IF P_ID_COMPROBANTE<>'00' THEN
                ...
                CALL pkg_pay_sp_ventas_academicas(P_ID_PERSONA,P_OPERACION,P_ID_ENTIDAD,P_ID_DEPTO,l_id_anho,l_id_mes,P_IMPORTE,P_IP,P_ID_ORIGEN,P_ID_CLIENTE,P_ID_COMPROBANTE,
            ...
            CALL pkg_pay_sp_crear_deposito_alumnoiddni(P_ID_ENTIDAD,P_ID_DEPTO,l_id_anho,l_id_mes,l_id_mediopago,l_id_user,P_ID_PERSONA,l_ventas,l_ventas_imp,l_tipo,l_id_tipotransaccion,
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE eliseo.pkg_pay_sp_deposito_alumno_visa_acad ( P_ID_ORDEN bigint, P_IMPORTE bigint, P_IP text, P_ID OUT text, P_ERROR OUT bigint, P_MSGERROR out text ) FROM PUBLIC;
