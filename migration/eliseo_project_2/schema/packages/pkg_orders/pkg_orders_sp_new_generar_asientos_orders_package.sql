...
CREATE OR REPLACE PROCEDURE eliseo.pkg_orders_sp_new_generar_asientos_orders (P_ID_PEDIDO bigint,P_ID_VOUCHER bigint,P_ERROR OUT bigint,P_MSN_ERROR OUT text) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE eliseo.pkg_orders_sp_new_generar_asientos_orders (P_ID_PEDIDO bigint,P_ID_VOUCHER bigint,P_ERROR OUT bigint,P_MSN_ERROR OUT text) FROM PUBLIC;
