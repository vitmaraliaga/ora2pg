...
CREATE OR REPLACE PROCEDURE eliseo.pkg_informes_sp_procesar_documentos_viajes ( P_IDS_DOCUMENTOS text, P_ID_VOUCHER bigint, P_TIPO text, -- 'L', 'NL'
...
--                     GOTO salida_rapida;
                ...
                -- Covertir el informe compra en compra
               	CALL pkg_informes_sp_convert_icompra_to_compra(
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE eliseo.pkg_informes_sp_procesar_documentos_viajes ( P_IDS_DOCUMENTOS text, P_ID_VOUCHER bigint, P_TIPO text, P_ERROR OUT bigint, P_MSGERROR OUT text ) FROM PUBLIC;
