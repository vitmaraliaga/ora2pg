...
CREATE OR REPLACE PROCEDURE eliseo.pkg_finances_students_sp_desc_especial (P_ID_ALUMNO_CONTRATO bigint,P_ID_CRITERIO_SEMESTRE bigint,P_TIPO_ALUMNO text,P_ERROR OUT bigint,P_MSGERROR out text) AS $body$
DECLARE
    ...
    l_importe_mat   decimal(10,2);
    l_tipo_valor_mat varchar(2);
    l_codigo varchar(25);
    l_tipo_cobro varchar(10);
...
BEGIN
    ...
    IF l_contar>0 THEN
      ...
      SELECT COALESCE(a.ENSENANZA,0),a.TIPO_ENSE,COALESCE(a.matricula,0),a.tipo_mat INTO STRICT l_importe,l_tipo_valor,l_importe_mat ,l_tipo_valor_mat
       FROM FIN_ALUMNO_DESCUENTO_VICE a,FIN_TIPO_DSCTO b 
      WHERE a.tipo_dscto=b.tipo_dscto
      and a.ID_PERSONA=l_id_persona
      and a.tipo_dscto=l_tipo_dscto
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE eliseo.pkg_finances_students_sp_desc_especial (P_ID_ALUMNO_CONTRATO bigint,P_ID_CRITERIO_SEMESTRE bigint,P_TIPO_ALUMNO text,P_ERROR OUT bigint,P_MSGERROR out text) FROM PUBLIC;
