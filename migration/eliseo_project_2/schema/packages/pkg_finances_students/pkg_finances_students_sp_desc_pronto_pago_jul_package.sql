...
CREATE OR REPLACE PROCEDURE eliseo.pkg_finances_students_sp_desc_pronto_pago_jul (P_ID_ALUMNO_CONTRATO bigint,P_ID_CRITERIO_SEMESTRE bigint,P_TIPO_ALUMNO text,P_ERROR OUT bigint,P_MSGERROR out text) AS $body$
DECLARE
...
BEGIN
    ...
    INTO STRICT l_id_semestre_programa,l_id_persona,l_misionero,l_id_plan_pago_semestre
...
--         goto salida_ptopago_jul;
    ...
    INTO STRICT l_cuotas,l_misionero
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE eliseo.pkg_finances_students_sp_desc_pronto_pago_jul (P_ID_ALUMNO_CONTRATO bigint,P_ID_CRITERIO_SEMESTRE bigint,P_TIPO_ALUMNO text,P_ERROR OUT bigint,P_MSGERROR out text) FROM PUBLIC;
