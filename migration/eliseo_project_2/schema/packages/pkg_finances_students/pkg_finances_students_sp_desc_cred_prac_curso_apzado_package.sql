...
CREATE OR REPLACE PROCEDURE eliseo.pkg_finances_students_sp_desc_cred_prac_curso_apzado (P_ID_ALUMNO_CONTRATO bigint,P_ID_CRITERIO_SEMESTRE bigint,P_TIPO_ALUMNO text,P_ERROR OUT bigint,P_MSGERROR out text) AS $body$
DECLARE
...
BEGIN
    ...
    SELECT COUNT(*) INTO STRICT l_contar  FROM MAT_PLAN_COSTO a, TT_CURSOS_X_PLAN b
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE eliseo.pkg_finances_students_sp_desc_cred_prac_curso_apzado (P_ID_ALUMNO_CONTRATO bigint,P_ID_CRITERIO_SEMESTRE bigint,P_TIPO_ALUMNO text,P_ERROR OUT bigint,P_MSGERROR out text) FROM PUBLIC;
