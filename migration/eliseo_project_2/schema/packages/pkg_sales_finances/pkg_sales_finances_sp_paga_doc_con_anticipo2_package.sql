...
CREATE OR REPLACE PROCEDURE eliseo.pkg_sales_finances_sp_paga_doc_con_anticipo2 (P_ID_ENTIDAD bigint,P_ID_DEPTO text,P_ID_PERSONA bigint,P_ID_CLIENTE bigint,P_ERROR OUT bigint,P_MSGERROR OUT text) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE eliseo.pkg_sales_finances_sp_paga_doc_con_anticipo2 (P_ID_ENTIDAD bigint,P_ID_DEPTO text,P_ID_PERSONA bigint,P_ID_CLIENTE bigint,P_ERROR OUT bigint,P_MSGERROR OUT text) FROM PUBLIC;
