...
CREATE OR REPLACE FUNCTION eliseo.pkg_sales_facturacion_fc_nota_credito (P_ID_VENTA bigint) RETURNS varchar AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION eliseo.pkg_sales_facturacion_fc_nota_credito (P_ID_VENTA bigint) FROM PUBLIC;
