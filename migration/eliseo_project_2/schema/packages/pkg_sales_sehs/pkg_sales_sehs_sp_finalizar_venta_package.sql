...
CREATE OR REPLACE PROCEDURE eliseo.pkg_sales_sehs_sp_finalizar_venta (P_ID_VENTA bigint,P_ID_CREDITO bigint,P_EFECTIVO bigint, P_CREDITO bigint, P_TARJETA bigint, P_ID_TIPO_TARJETA bigint, P_OPERACION text, P_ERROR OUT bigint,P_MSGERROR out text, P_ES_AUTOCONSUMO text DEFAULT NULL, P_TARJETA2 bigint DEFAULT NULL, P_ID_TIPO_TARJETA2 bigint DEFAULT NULL, P_OPERACION2 text DEFAULT NULL,P_ID_CTABANCARIA bigint DEFAULT NULL, P_ID_CTABANCARIA2 bigint DEFAULT NULL) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE eliseo.pkg_sales_sehs_sp_finalizar_venta (P_ID_VENTA bigint,P_ID_CREDITO bigint,P_EFECTIVO bigint, P_CREDITO bigint, P_TARJETA bigint, P_ID_TIPO_TARJETA bigint, P_OPERACION text, P_ERROR OUT bigint,P_MSGERROR out text, P_ES_AUTOCONSUMO text DEFAULT NULL, P_TARJETA2 bigint DEFAULT NULL, P_ID_TIPO_TARJETA2 bigint DEFAULT NULL, P_OPERACION2 text DEFAULT NULL,P_ID_CTABANCARIA bigint DEFAULT NULL, P_ID_CTABANCARIA2 bigint DEFAULT NULL) FROM PUBLIC;
