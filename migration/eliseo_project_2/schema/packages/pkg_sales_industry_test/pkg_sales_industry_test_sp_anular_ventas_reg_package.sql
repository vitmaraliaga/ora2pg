...
CREATE OR REPLACE PROCEDURE eliseo.pkg_sales_industry_test_sp_anular_ventas_reg (P_ID_VENTA bigint, P_ID_PERSONA bigint, P_MOTIVO text, P_ERROR OUT bigint, P_MSGERROR OUT text) AS $body$
DECLARE
...
--                 GOTO salida_rapida;
            END IF;
                ...
                SELECT ID_ENTIDAD, id_depto, 1 as id_tipoarreglo, P_ID_PERSONA, 13, id_venta, id_tipoorigen, P_MOTIVO, clock_timestamp(), 
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE eliseo.pkg_sales_industry_test_sp_anular_ventas_reg (P_ID_VENTA bigint, P_ID_PERSONA bigint, P_MOTIVO text, P_ERROR OUT bigint, P_MSGERROR OUT text) FROM PUBLIC;
