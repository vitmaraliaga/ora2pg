...
CREATE OR REPLACE PROCEDURE eliseo.pkg_prof_sp_desc_hijo_misionero (P_ID_PROFORMA bigint,P_ID_CRITERIO_SEMESTRE bigint,P_ERROR OUT bigint,P_MSGERROR out text) AS $body$
DECLARE
...
BEGIN
    ...
    INTO STRICT l_id_persona,l_id_semestre_programa,l_id_postulante,l_tipo_hijo
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE eliseo.pkg_prof_sp_desc_hijo_misionero (P_ID_PROFORMA bigint,P_ID_CRITERIO_SEMESTRE bigint,P_ERROR OUT bigint,P_MSGERROR out text) FROM PUBLIC;
