...
CREATE OR REPLACE PROCEDURE eliseo.pkg_bi_spc_bi_tesoreria (OUT CURSOR REFCURSOR ) AS $body$
BEGIN
            OPEN CURSOR FOR
            SELECT 
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE eliseo.pkg_bi_spc_bi_tesoreria (OUT CURSOR REFCURSOR ) FROM PUBLIC;
