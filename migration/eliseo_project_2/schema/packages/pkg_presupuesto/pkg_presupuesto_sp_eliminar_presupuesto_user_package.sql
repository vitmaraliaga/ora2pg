...
CREATE OR REPLACE PROCEDURE eliseo.pkg_presupuesto_sp_eliminar_presupuesto_user (P_ID_PRESUPUESTO bigint,P_ID_PERSONA bigint) AS $body$
BEGIN
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE eliseo.pkg_presupuesto_sp_eliminar_presupuesto_user (P_ID_PRESUPUESTO bigint,P_ID_PERSONA bigint) FROM PUBLIC;
