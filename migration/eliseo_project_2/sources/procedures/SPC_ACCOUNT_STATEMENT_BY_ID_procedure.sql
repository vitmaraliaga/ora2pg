...
PROCEDURE        spc_account_statement_by_id (
    p_id_entidad           int,
    p_id_anho           int,
    p_id_mes           int,
    p_id_persona       int,
...
;
    ...
    DBMS_OUTPUT.PUT_LINE(l_descuentos);
    DBMS_OUTPUT.PUT_LINE('l_descuento_extraordinario');
    DBMS_OUTPUT.PUT_LINE(l_descuento_extraordinario);
    DBMS_OUTPUT.PUT_LINE('l_descuentos_ayudas');
    DBMS_OUTPUT.PUT_LINE(l_descuentos_ayudas);
    DBMS_OUTPUT.PUT_LINE('l_descuentos_viajes');
    DBMS_OUTPUT.PUT_LINE(l_descuentos_viajes);
    DBMS_OUTPUT.PUT_LINE('l_descuentos_adelantos');
    DBMS_OUTPUT.PUT_LINE(l_descuentos_adelantos);
    ...
    DBMS_OUTPUT.PUT_LINE(p_sueldo);
    DBMS_OUTPUT.PUT_LINE('variable out');
