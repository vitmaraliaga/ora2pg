...
PROCEDURE        iudp_Diario (P_Modo int, P_ID_ENTIDAD int, P_COD_AASI int, P_ID_TIPOASIENTO varchar2, P_FEC_ASIENTO varchar2, P_FEC_DIGITADO varchar2, P_FEC_CONTABILIZADO varchar2, P_NOM_DIGITADOR VARCHAR2, 
...
BEGIN
    ...
    IF P_Modo = 0 THEN
        ...
        -- Seguimiento para obligar al usuario actualizar la paginación
        SELECT
                COUNT(1) INTO S_CONT
        ...
        AND ID_ANHO = S_ID_ANHO;
       	...
       	IF S_CONT>0 THEN 
	        ...
	        SET FECHA_LOTES_ACTUALIZADOS = SYSDATE 
	        WHERE ID_ENTIDAD =P_ID_ENTIDAD
	        AND ID_ANHO =S_ID_ANHO;
       	ELSE 
       		SELECT MAX(ID_EMPRESA) INTO S_ID_EMPRESA FROM CONTA_ENTIDAD ce WHERE ce.ID_ENTIDAD=	P_ID_ENTIDAD;
       	
       		INSERT INTO CONTA_DIARIO_PAGINACION(ID_EMPRESA, ID_ENTIDAD, ID_ANHO, FECHA_LOTES_ACTUALIZADOS)
       		values(S_ID_EMPRESA,P_ID_ENTIDAD, S_ID_ANHO, sysdate);
       	END IF;
