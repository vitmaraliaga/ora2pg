...
PROCEDURE        scp_dinamic_clone_by_id_ed(
...
BEGIN
    ...
    IF L_ERROR = 0 THEN 
        ...
        LOOP
                ...
                DBMS_OUTPUT.put_line('Departamento: ' || v_ID_DEPTO_TO);
                ...
                VALUES(v_ID_ENTIDAD_TO, v_ID_DEPTO_TO, v_ID_YEAR_TO, rec_1.ID_MODULO, rec_1.ID_TIPOIGV,
                ...
                DBMS_OUTPUT.put_line('Paso: ' || v_ID_DEPTO_TO);
                    ...
                    INSERT INTO CONTA_DINAMICA_ASIENTO(
                       ...
                       -- DBMS_OUTPUT.PUT_LINE(d_cc_record.ID_CTACTE);
                        ...
                        OPEN v_d_d_cursor FOR v_d_d_stmt_str USING d_a_record.ID_ASIENTO;
                            ...
                            DBMS_OUTPUT.PUT_LINE('>>>d_d_record.ID_ENTIDAD ' || v_ID_ENTIDAD_TO);
                            DBMS_OUTPUT.PUT_LINE('>>>d_d_record.ID_DEPTO ' || v_ID_DEPTO_TO);
                            DBMS_OUTPUT.PUT_LINE('>>>d_a_record.ID_ASIENTO ' || d_a_record.ID_ASIENTO);
                            DBMS_OUTPUT.PUT_LINE('>>>d_a_record.ID_ASIENTO ' || d_a_record.ID_ASIENTO);
                            DBMS_OUTPUT.PUT_LINE('>>>rec_1.ID_DINAMICA ' || rec_1.ID_DINAMICA);
                            DBMS_OUTPUT.PUT_LINE('>>>rec_1.ID_ENTIDAD ' || v_ID_ENTIDAD_TO);
                           
                            SELECT COUNT(1) INTO l_contar FROM CONTA_ENTIDAD_DEPTO ced WHERE ID_ENTIDAD = v_ID_ENTIDAD_TO
                            AND ID_DEPTO=d_d_record.ID_DEPTO;
                            
                            IF l_contar=0 THEN 
                            	L_ERROR := 1;
                            	L_MSGERROR := 'Alto: La entidad '||v_ID_ENTIDAD_TO||' no tiene al departamento '||d_d_record.ID_DEPTO||' uno de los asientos lo usa.';
                            	--goto salida_rapida;
                            END IF;
                        ...
                        OPEN v_d_a_ch_cursor FOR v_d_a_ch_stmt_str USING rec_1.ID_DINAMICA, d_a_record.ID_ASIENTO;
                            ...
                            INSERT INTO CONTA_DINAMICA_ASIENTO(
                               ...
                               -- DBMS_OUTPUT.PUT_LINE(d_cc_record.ID_CTACTE);
                                    INSERT INTO CONTA_DINAMICA_CTA_CTE(ID_ASIENTO, ID_ENTIDAD, ID_CTACTE)
                                                VALUES(l_id_asiento_child, v_ID_ENTIDAD_TO, d_cc_record.ID_CTACTE);
                                END LOOP;
                                CLOSE v_d_cc_cursor;	 
                                DBMS_OUTPUT.PUT_LINE('Aqui estamos');
                                v_d_d_stmt_str := 'SELECT * FROM CONTA_DINAMICA_DEPTO WHERE id_asiento = :1';
                                OPEN v_d_d_cursor FOR v_d_d_stmt_str USING d_a_ch_record.ID_ASIENTO;
                                    ...
                                    DBMS_OUTPUT.PUT_LINE('>>>v_ID_ENTIDAD ' || v_ID_ENTIDAD_TO);
                                    DBMS_OUTPUT.PUT_LINE('>>>d_d_record.ID_ENTIDAD ' || v_ID_ENTIDAD_TO);
		                            ...
		                            END IF;
		                           	...
		                           	IF L_ERROR = 0 THEN 
                                    	INSERT INTO CONTA_DINAMICA_DEPTO(ID_ASIENTO, ID_ENTIDAD, ID_DEPTO)
                                                VALUES(l_id_asiento_child, v_ID_ENTIDAD_TO, d_d_record.ID_DEPTO);
                                    END IF;
                                END LOOP;
                                CLOSE v_d_d_cursor;	
                ...
                LOOP
                        ...
                        ID_TIPOTRANSACCION, ID_PERSONA, ID_PARENT, ID_CTABANCARIA, ID_ALMACEN, NOMBRE, IMPORTE, 
                        FECHA, COMENTARIO, IP, ACTIVO)
                        VALUES(v_ID_ENTIDAD_TO, v_ID_DEPTO_TO, v_ID_YEAR_TO, rec_2.ID_MODULO, rec_2.ID_TIPOIGV,
