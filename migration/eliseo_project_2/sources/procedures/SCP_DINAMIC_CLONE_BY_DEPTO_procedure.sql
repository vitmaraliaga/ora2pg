...
PROCEDURE        scp_dinamic_clone_by_depto(
...
BEGIN
    ...
    IF l_contar > 0 THEN 
        L_ERROR := 1;
        L_MSGERROR := 'Alto: Ya existen dinámicas en el DEPARTAMENTO : '||v_ID_DEPTO_TO;
        goto salida_rapida;
    END IF;
    ...
    IF L_ERROR = 0 THEN 
        ...
        LOOP
                ...
                VALUES(l_id_dinamica, v_ID_ENTIDAD, v_ID_DEPTO_TO, v_ID_YEAR, rec_1.ID_MODULO, rec_1.ID_TIPOIGV,
                       ...
                       -- DBMS_OUTPUT.PUT_LINE(d_cc_record.ID_CTACTE);
                        ...
                        OPEN v_d_a_ch_cursor FOR v_d_a_ch_stmt_str USING rec_1.ID_DINAMICA, d_a_record.ID_ASIENTO;
                            ...
                            INSERT INTO CONTA_DINAMICA_ASIENTO(
                                        ...
                                        VALUES(
                                            -- l_id_asiento, 
                                            d_a_ch_record.ID_PARENT, l_id_dinamica, d_a_ch_record.ID_TIPOPLAN, 
