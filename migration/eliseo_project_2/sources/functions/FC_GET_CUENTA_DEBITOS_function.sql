...
FUNCTION        FC_GET_CUENTA_DEBITOS(entidad IN NUMBER, ctacte IN NUMBER) 
   RETURN NUMBER 
   IS cuenta NUMBER;
   s_id_empresa number;
   s_id_tipoentidad number;
   s_id_empresa_ctacte number;
   BEGIN 
      s_id_empresa := -1;
      ...
      select 
        ...
        into s_id_empresa,s_id_empresa_ctacte,s_id_tipoentidad 
      from dual;
