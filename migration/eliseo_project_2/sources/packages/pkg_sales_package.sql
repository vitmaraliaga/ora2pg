...
SELECT 'CC'||'|'||'0101'||
 ...
 SELECT  'DD'||	'|'||ROWNUM||
   ...
   V.id_comprobante
        ...
        SELECT 
            --Documento
            (CASE WHEN '1'=decode(ca.cuenta,'1132001','1','1132006','1','2161004','1','2162006','1','X') 
                    THEN COALESCE((SELECT 'C/'||codigo||'/' FROM MOISES.persona_natural_alumno WHERE id_persona=v.id_cliente),
                          (SELECT y.id_tipodocumento||'/'||x.num_documento||'/' FROM MOISES.persona_documento x 
                                ...
                                WHERE x.id_persona=v.id_cliente AND y.id_tipodocumento IN('1','4','6','7','0','31') AND ROWNUM=1),(''))
            END)||
            --Corelativo
            (v.serie||'-'||v.numero||'/')||
            --IGV
            ...
            --GLOSA
            SUBSTR(V.glosa,1,decode(ca.cuenta,'1132001',34,'1132006',34,'2161004',34,'2162006',34,45)) INTO L_DESCRIPCION_2 
                FROM ELISEO.CONTA_ASIENTO ca
                JOIN ELISEO.VENTA_DETALLE vd ON vd.ID_VDETALLE=ca.ID_ORIGEN
                JOIN ELISEO.VENTA v ON v.ID_VENTA=vd.ID_VENTA
