...
CREATE OR REPLACE VIEW vw_sales_detail_saldo_col (id_entidad, id_depto, id_anho, id_venta, id_articulo, id_cliente, id_sucursal, serie, numero, importe, importe_me, debe, haber, debe_saldo) AS SELECT 
    ...
    SUM(CASE WHEN DOCUMENTO_MOV = 'Dev.' THEN 0 ELSE CASE WHEN IMPORTE > 0 THEN IMPORTE ELSE 0 END END ) AS DEBE_SALDO
    --,SUM(TOTAL) TOTAL
