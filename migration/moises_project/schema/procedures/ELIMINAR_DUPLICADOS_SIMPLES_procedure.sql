...
CREATE OR REPLACE PROCEDURE moises.eliminar_duplicados_simples (v_persona_1 integer,v_persona_2 integer) AS $body$
BEGIN
  ...
  delete FROM moises.persona_natural where  Id_Persona=v_persona_2;commit;
  commit;
end;
$body$
LANGUAGE PLPGSQL
;
-- REVOKE ALL ON PROCEDURE moises.eliminar_duplicados_simples (v_persona_1 integer,v_persona_2 integer) FROM PUBLIC;
