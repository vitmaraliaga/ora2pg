...
BEGIN
  IF P_Modo = 0 THEN
	...
	CALL moises.iudp_Persona_Natural(0, P_NUM_DOCUMENTO, P_ID_TIPODOCUMENTO, P_NOMBRE, P_PATERNO, P_MATERNO, P_ID_ESTADOCIVIL, NULL, P_COD_PAIS, P_COD_PAIS, NULL, S_SEXO, P_FEC_NACIMIENTO, NULL, S_ID_PERSONA);
	...
	IF (S_COD_ASSINET IS NOT NULL AND S_COD_ASSINET::text <> '') THEN
