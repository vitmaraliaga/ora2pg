...
CREATE TABLE contribuyente_contacto (
	id_contribuyente_contacto bigint NOT NULL,
	id_persona bigint,
	id_tipopais bigint,
	celular varchar(50),
	correo varchar(300),
...
CREATE TABLE modulo_notificacion (
	id_modulo_notificacion bigint NOT NULL,
	id_notificacion bigint NOT NULL,
	id_modulo bigint NOT NULL,
	id_persona_origen bigint NOT NULL,
	id_persona_destinatario bigint NOT NULL,
...
CREATE TABLE persona_apoderado (
	id_persona bigint NOT NULL,
	id_resp_financiero bigint NOT NULL,
...
CREATE TABLE persona_embargo_judicial (
	id_persona_ejudicial bigint NOT NULL,
	id_persona bigint,
...
CREATE TABLE persona_informacion_academica (
	id_informacion_academica bigint NOT NULL,
	id_persona bigint NOT NULL,
	id_situacion_educativa varchar(20) NOT NULL,
...
CREATE TABLE persona_natural (
	...
	foto varchar(4000),
	firma varchar(50),
	credito_pronabec bigint NOT NULL DEFAULT 0,
	fecha_ingreso timestamp(0),
...
CREATE TABLE persona_natural_redsocial (
	id_redsocial bigint NOT NULL,
	id_persona bigint NOT NULL,
	id_tipo_redsocial bigint NOT NULL,
...
CREATE TABLE tipo_autoridad_iglesia (
	id_tipoautoridadiglesia bigint NOT NULL,
	nombre varchar(50),
	vigencia bigint
) ;
...
CREATE TABLE tipo_identidad_etnica (
	id_tipo_identidad_etnica bigint NOT NULL,
	nombre varchar(100),
	siglas varchar(20),
	vigencia bigint
) ;
...
CREATE TABLE tipo_situacion_laboral (
	id_situacion_laboral bigint NOT NULL,
	nombre varchar(200),
	codigo varchar(20),
...
CREATE TABLE trabajador_area (
	id_trabajador_area bigint NOT NULL,
	id_trabajador bigint NOT NULL,
	id_sedearea bigint,
	desde timestamp(0),
	hasta timestamp(0),
...
CREATE TABLE trabajador_ccosto (
	id_trabajador_ccosto bigint NOT NULL,
	id_trabajador bigint NOT NULL,
	id_sedearea bigint,
	desde timestamp(0),
	hasta timestamp(0),
...
CREATE TABLE trabajador_sit_esp (
	id_trabajador_sit_esp bigint NOT NULL,
	id_trabajador bigint NOT NULL,
	id_situacion_especial varchar(2) NOT NULL,
	desde timestamp(0),
	hasta timestamp(0),
...
CREATE TABLE vinculo_familiar (
	id_vinculo_familiar bigint NOT NULL,
	id_persona bigint NOT NULL,
	id_tipo_vinculo_familiar varchar(2) NOT NULL,
