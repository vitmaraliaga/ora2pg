...
CREATE OR REPLACE PROCEDURE moises.persona_trabajador_sp_datos_personales ( P_ID_PERSONA bigint, P_NOMBRE text, P_PATERNO text, P_MATERNO text, P_SEXO text, P_FEC_NACIMIENTO timestamp(0), P_ID_TIPOESTADOCIVIL bigint, P_ID_TIPOPAIS bigint, P_ID_UBIGEO bigint, P_ID_TIPODOCUMENTO bigint, P_NUM_DOCUMENTO text, P_FEC_CADUCIDAD timestamp(0), P_ID_TIPOSANGRE bigint, P_TELEFONO text, P_CELULAR text, P_CORREO text, P_CORREO_INST text, P_IDTIPORELIGION bigint, P_ID_IGLESIA text, P_FECHA_BAUTIZO timestamp(0), P_TIENE_CARGO text, P_CARGO_IGLESIA text, P_ID_TIPOAUTORIDADIGLESIA bigint, P_NOMBRE_AUTORIDAD text, P_TLF_AUTORIDAD text, P_UNAPELLIDO text, P_ID_TIPO_IDENTIDAD_ETNICA bigint, P_EMERGENCIA_PERSONA text, P_EMERGENCIA_TLF text, P_FECHA_INGRESO text, P_ERROR OUT bigint,P_MSGERROR out text,P_ID_PERSONA_NEW out bigint ) AS $body$
DECLARE
...
BEGIN
    ...
    if (P_CORREO_INST IS NOT NULL AND P_CORREO_INST::text <> '') then
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE moises.persona_trabajador_sp_datos_personales ( P_ID_PERSONA bigint, P_NOMBRE text, P_PATERNO text, P_MATERNO text, P_SEXO text, P_FEC_NACIMIENTO timestamp(0), P_ID_TIPOESTADOCIVIL bigint, P_ID_TIPOPAIS bigint, P_ID_UBIGEO bigint, P_ID_TIPODOCUMENTO bigint, P_NUM_DOCUMENTO text, P_FEC_CADUCIDAD timestamp(0), P_ID_TIPOSANGRE bigint, P_TELEFONO text, P_CELULAR text, P_CORREO text, P_CORREO_INST text, P_IDTIPORELIGION bigint, P_ID_IGLESIA text, P_FECHA_BAUTIZO timestamp(0), P_TIENE_CARGO text, P_CARGO_IGLESIA text, P_ID_TIPOAUTORIDADIGLESIA bigint, P_NOMBRE_AUTORIDAD text, P_TLF_AUTORIDAD text, P_UNAPELLIDO text, P_ID_TIPO_IDENTIDAD_ETNICA bigint, P_EMERGENCIA_PERSONA text, P_EMERGENCIA_TLF text, P_FECHA_INGRESO text, P_ERROR OUT bigint,P_MSGERROR out text,P_ID_PERSONA_NEW out bigint ) FROM PUBLIC;
