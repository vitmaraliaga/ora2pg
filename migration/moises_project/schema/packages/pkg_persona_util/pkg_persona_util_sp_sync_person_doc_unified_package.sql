...
CREATE OR REPLACE PROCEDURE moises.pkg_persona_util_sp_sync_person_doc_unified (P_ID_PERSONA bigint,P_ERROR OUT bigint,P_MSGERROR out text) AS $body$
DECLARE
        ...
        WHERE (QUERY IS NOT NULL AND QUERY::text <> '') 
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE moises.pkg_persona_util_sp_sync_person_doc_unified (P_ID_PERSONA bigint,P_ERROR OUT bigint,P_MSGERROR out text) FROM PUBLIC;
