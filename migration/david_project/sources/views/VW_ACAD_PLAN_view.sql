...
CREATE OR REPLACE VIEW vw_acad_plan (id_plan, id_facultad, nom_facultad, cod_facultad, id_escuela, nom_escuela, cod_escuela, escuela_profesional, nombre_plan, fecha_inicio, fecha_fin, numero_cursos, nota_aprobatoria, id_semestre) AS select ap.id_plan,nvl(decode(op.id_parent,8,8,null), op.id_area) id_facultad, decode(decode(op.id_parent,8,8,null),null,op.nombre,opp.nombre) nom_facultad,
decode(decode(op.id_parent,8,8,null),null,op.codigo,opp.codigo) cod_facultad , 
oa.id_area id_escuela, oa.nombre nom_escuela, oa.codigo cod_escuela,nvl(nep.Nombre,oa.Nombre) escuela_profesional,
