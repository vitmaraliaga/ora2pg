...
decode(substr(vpp.Nombre_Plan,-1),'1','01/01/','01/06/')||substr(vpp.Nombre_Plan,0,4) dtIngresso,
Pa.Apellido_Nombre Nome,Pa.Sexo,Pa.Fec_Nacimiento dtAniversario,
decode(Pa.Religion,'Adventista del Séptimo Día','TRUE','FALSE') isAdventista,
