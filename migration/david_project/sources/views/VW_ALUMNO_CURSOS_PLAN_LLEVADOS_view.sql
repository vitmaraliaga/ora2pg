...
inner join (
            ...
            inner join acad_curso_alumno aca on aca.ID_CURSO_DETALLE=vce.CURSO_EQUIV and aca.id_tipo_condicion <> 7 and aca.estado='1'
            where apce.ID_PLAN_CURSO_ELECTIVO is not null) apc on apc.ID_CURSO_DETALLE=acp.ID_CURSO_DETALLE and apc.id_plan=vpp.id_plan
where acp.ID_PLAN_CURSO_ELECTIVO is null 
