...
FUNCTION ft_num_horas_cruce_curso( p_id_carga_curso_docente integer,p_id_semestre integer, p_id_programa_estudio integer, p_ciclo integer, p_grupo varchar2) RETURN number IS
