...
FUNCTION       FT_CAMPUS_ALUMNO_ND(P_NUM_DOC IN Varchar2) 
RETURN VARCHAR2
IS
...
SELECT
	DISTINCT CAMPUS_ADS INTO P_CAMPUS
FROM
	(
	SELECT
		apc.campus_ads,
...
SELECT DECODE(B.ID_SEDE, '1', 'Sede Lima', '2', 'Sede Juliaca', '3', 'Sede Tarapoto') INTO P_CAMPUS
