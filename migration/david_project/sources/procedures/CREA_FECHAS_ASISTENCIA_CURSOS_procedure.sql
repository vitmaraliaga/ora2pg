...
procedure CREA_FECHAS_ASISTENCIA_CURSOS( p_val in integer, p_id_nivel_ensenanza in integer) AS 
  ...
  delete acad_doc_asistencia where id_semestre=p_id_semestre and id_nivel_ensenanza=p_id_nivel_ensenanza and no_medicina=1;
  commit;
