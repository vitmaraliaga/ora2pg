...
begin
  ...
  loop
   ...
   if (req.codigo='G14') then
    ...
    insert into acad_alumno_requisitos_beca 
    (id_solicitud_mat_alum,id_requisitos_beca,estado,observacion,id_usuario_reg,fecha_registro)
    values(v_id_solicitud_mat_alum,req.id_requisitos_beca,p_estado,p_obs,v_id_usuario,sysdate);
    commit;
