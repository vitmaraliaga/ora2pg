...
procedure       pcd_anular_variacion_alumno(p_id_alumno_contrato integer)
 is
 ...
 begin 
  ...
  EXECUTE IMMEDIATE 'truncate table aatemp_cursos_a_borrar';
    commit; 
 ...
 select Id_Curso_alumno,id_alumno_contrato 
    from acad_curso_variacion
    	where Id_Alumno_Contrato=p_id_alumno_contrato AND ID_CURSO_ALUMNO
 ...
 DELETE eliseo.MAT_ALUMNO_CONTRATO_ASIENTO WHERE id_alumno_contrato  = p_id_alumno_contrato;
  COMMIT; 
 
 
 DELETE eliseo.MAT_ALUMNO_CONTRATO_CUOTA WHERE id_alumno_contrato  = p_id_alumno_contrato;
  COMMIT; 
  
 DELETE eliseo.MAT_ALUMNO_CONTRATO_DET WHERE id_alumno_contrato  = p_id_alumno_contrato;
  COMMIT; 
  
 DELETE eliseo.MAT_ALUMNO_CONTRATO_RECAL WHERE id_alumno_contrato  = p_id_alumno_contrato;
  COMMIT; 
 ...
 DELETE eliseo.MAT_ALUMNO_CONTRATO_RECAL WHERE id_alumno_contrato  = p_id_alumno_contrato;
  ...
  delete ACAD_CURSO_VARIACION where id_alumno_contrato=p_id_alumno_contrato;
  commit;
  
  delete ACAD_DELEGADO where ID_CURSO_ALUMNO IN (select id_curso_alumno from acad_curso_alumno 
                                                  ...
                                                  and id_tipo_condicion not in ('1','2'));
  commit;
  delete DETALLE_CURSO_TRAMITE where ID_CURSO_ALUMNO IN (select id_curso_alumno from acad_curso_alumno 
                                                          where  id_curso_alumno in (select id_curso_alumno from aatemp_cursos_a_borrar where id_alumno_contrato=p_id_alumno_contrato)
                                                          and id_tipo_condicion not in ('1','2'));
  commit;
  delete ACAD_CURSO_ALUMNO_AMBIENTE where ID_CURSO_ALUMNO IN (select id_curso_alumno from acad_curso_alumno 
                                                              where  id_curso_alumno in (select id_curso_alumno from aatemp_cursos_a_borrar where id_alumno_contrato=p_id_alumno_contrato)
                                                              and id_tipo_condicion not in ('1','2'));
  commit;
  delete ACAD_SUBGRUPO_ESTUDIANTE where ID_CURSO_ALUMNO IN (select id_curso_alumno from acad_curso_alumno 
                                                            where  id_curso_alumno in (select id_curso_alumno from aatemp_cursos_a_borrar where id_alumno_contrato=p_id_alumno_contrato)
                                                            and id_tipo_condicion not in ('1','2'));
  commit;
  
  delete acad_curso_alumno where  id_curso_alumno in (select id_curso_alumno from aatemp_cursos_a_borrar where id_alumno_contrato=p_id_alumno_contrato)
  and id_tipo_condicion not in ('1','2');
  commit;
