...
procedure pcd_create_copia_plan(
  p_id_plan integer, 
  p_id_usuario_reg integer
)
 is
     
    --lista de cursos del máximo plan
    cursor curso_plan is
...
begin
  ...
  begin
    ...
    pcd_create_copia_plan_pre(p_id_plan,p_id_usuario_reg);
