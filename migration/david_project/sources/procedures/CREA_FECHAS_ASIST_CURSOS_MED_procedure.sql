...
procedure CREA_FECHAS_ASIST_CURSOS_MED( p_id_semestre in integer, p_id_nivel_ensenanza in integer) AS 
  ...
  delete acad_doc_asistencia where id_semestre=p_id_semestre and id_nivel_ensenanza=p_id_nivel_ensenanza and no_medicina=0;
  commit;
