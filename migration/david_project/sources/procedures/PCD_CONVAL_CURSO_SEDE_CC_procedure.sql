...
PROCEDURE pcd_conval_curso_sede_cc (p_id_persona integer,p_id_plan_programa_a integer,p_id_plan_programa_n integer, p_id_usuario_reg integer, cursor out sys_refcursor) IS
...
BEGIN
  ...
  for cc in cursos loop
    ...
    values(cc.ID_PERSONA,p_id_plan_programa_n,cc.ID_CURSO_DETALLE,19,cc.ID_TIPO_CONDICION,cc.ID_PLAN_CURSO,cc.PROMEDIO,cc.ALCANZADO,cc.ESTADO,p_id_usuario_reg,sysdate,cc.FECHA_FIN_CURSO);
  ...
  open cursor for 
            select l_contar as resultado, l_error as msg_error,l_val_id_plan_curso id_plan_curso from dual;
