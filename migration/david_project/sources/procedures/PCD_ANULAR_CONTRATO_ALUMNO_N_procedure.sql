...
procedure             pcd_anular_contrato_alumno_n(p_id_alumno_contrato integer)
 is
 ...
 begin 
  ...
  commit;
    ...
    delete TU_ESTUDIANTE where id_alumno_contrato=p_id_alumno_contrato;
  commit;
  ...
  delete Acad_Alumno_Contrato_Curso where id_curso_alumno in (select id_curso_alumno from aatemp_cursos_a_borrar where id_alumno_contrato=p_id_alumno_contrato);
  commit;
