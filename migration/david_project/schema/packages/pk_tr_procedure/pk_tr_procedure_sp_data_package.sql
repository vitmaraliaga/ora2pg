...
CREATE OR REPLACE PROCEDURE david.pk_tr_procedure_sp_data ( P_PROCEDURE_PERSON_ID bigint, P_CURSOR OUT REFCURSOR) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE david.pk_tr_procedure_sp_data ( P_PROCEDURE_PERSON_ID bigint, P_CURSOR OUT REFCURSOR) FROM PUBLIC;
