...
CREATE OR REPLACE VIEW vw_change_notes_same (id_nivel_ensenanza, id_semestre, id_carga_curso, id_carga_evaluacion, id_persona, fecha, fecha_registro, hora_registro, ip, sede, nombre_facultad, nombre_escuela, ciclo, grupo, nombre_curso, estudiante, codigo, evaluacion, nota_anterior, nota_actual, nombre_docente, registrador, usuario) AS select distinct aca.Id_Nivel_Ensenanza,aca.Id_Semestre,aca.Id_Carga_Curso,ace.Id_Carga_Evaluacion,aca.id_persona,er.Fecha_Registro fecha,
...
coalesce(coalesce(ace.Descripcion,ace.Rau),Ae.Nombre) evaluacion,
er.Nota_Anterior,er.Nota_Actual,coalesce(d.Nombre_Docente,'NO REGISTRADO')::text Nombre_Docente,PC.Apellido_Nombre registrador,u.email usuario
