...
pn.Fec_Nacimiento,Ts.Nombre sexo, pn.sexo id_sexo, coalesce(tdc.Nombre,'Ninguna') discapacidad,
Ts.Codigo codigo_sexo,tr.Codigo codigo_religion,
Tp.Nombre pais, pn.Id_Tipopais,coalesce(tr.Nombre,'Otro') religion,Tec.Nombre estado_civil,
