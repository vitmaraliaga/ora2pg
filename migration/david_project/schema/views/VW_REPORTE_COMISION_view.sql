...
CREATE OR REPLACE VIEW vw_reporte_comision (codigo_solicitud, id_persona, codigo_estudiante, plan_origen, programa_origen, plan_destino, programa_destino, fecha_registro, semestre, tipo_tramite, descripcion, institucion, estudiante) AS SELECT
