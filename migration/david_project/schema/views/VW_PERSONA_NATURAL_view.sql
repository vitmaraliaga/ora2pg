...
(select estado from moises.verificacion v where v.tipo='C' and v.id_persona=p.id_persona and v.valor=pt.num_telefono  LIMIT 1) verificacion_codigo_celular,
(select estado from moises.verificacion v where v.tipo='V' and v.id_persona=p.id_persona and v.valor=pv.direccion  LIMIT 1) verificacion_codigo_correo,correo
