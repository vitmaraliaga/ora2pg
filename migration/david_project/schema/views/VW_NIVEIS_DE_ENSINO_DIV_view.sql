...
CREATE OR REPLACE VIEW vw_niveis_de_ensino_div (id_niveis_ensino, id_escola, descricao, anio) AS select Distinct tne.Id_Nivel_Ensenanza id_Niveis_Ensino,ape.Id_Facultad id_Escola,tne.nombre descricao,substr(asm.semestre,0,4) anio
...
inner join Tipo_Nivel_Ensenanza tne on tne.Id_Nivel_Ensenanza=ape.Id_Nivel_Ensenanza
