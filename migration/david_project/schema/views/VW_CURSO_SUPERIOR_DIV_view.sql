...
CREATE OR REPLACE VIEW vw_curso_superior_div (id_curso, id_escola, descricao, anio) AS select Distinct ape.Id_Escuela id_Curso,ape.Id_Facultad id_Escola,ape.Nombre_Certificado descricao,substr(asm.semestre,0,4) anio
...
order by substr(asm.semestre,0,4),ape.Id_Facultad,ape.Nombre_Certificado;
