...
CREATE OR REPLACE FUNCTION david.ft_graduado_plan (p_id_persona integer,p_id_plan_programa integer) RETURNS bigint AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION david.ft_graduado_plan (p_id_persona integer,p_id_plan_programa integer) FROM PUBLIC;
