...
CREATE OR REPLACE FUNCTION david.ft_num_horas_cruce_curso ( p_id_carga_curso_docente integer,p_id_semestre integer, p_id_programa_estudio integer, p_ciclo integer, p_grupo text) RETURNS bigint AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION david.ft_num_horas_cruce_curso ( p_id_carga_curso_docente integer,p_id_semestre integer, p_id_programa_estudio integer, p_ciclo integer, p_grupo text) FROM PUBLIC;
