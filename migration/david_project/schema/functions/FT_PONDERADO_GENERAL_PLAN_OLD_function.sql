...
CREATE OR REPLACE FUNCTION david.ft_ponderado_general_plan_old (p_id_persona integer,p_id_plan_programa integer) RETURNS bigint AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION david.ft_ponderado_general_plan_old (p_id_persona integer,p_id_plan_programa integer) FROM PUBLIC;
