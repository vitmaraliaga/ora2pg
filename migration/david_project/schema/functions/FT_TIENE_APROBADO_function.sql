...
CREATE OR REPLACE FUNCTION david.ft_tiene_aprobado (v_id_persona integer,v_id_plan_programa integer) RETURNS bigint AS $body$
DECLARE

  p_res bigint;
  p_monto bigint;
  p_id_escuela varchar(50);
  p_estado bigint;
  p_promedio bigint;

BEGIN

  select id_escuela into STRICT p_id_escuela
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION david.ft_tiene_aprobado (v_id_persona integer,v_id_plan_programa integer) FROM PUBLIC;
