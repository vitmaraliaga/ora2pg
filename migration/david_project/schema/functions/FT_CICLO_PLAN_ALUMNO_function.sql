...
CREATE OR REPLACE FUNCTION david.ft_ciclo_plan_alumno (p_id_persona integer,p_id_plan_programa integer) RETURNS bigint AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION david.ft_ciclo_plan_alumno (p_id_persona integer,p_id_plan_programa integer) FROM PUBLIC;
