...
CREATE OR REPLACE FUNCTION david.fc_is_available_lab ( P_ROOM_ID DAVID.LAB_OCURRENCIA.ID_AMBIENTE%TYPE, P_QUOTA DAVID.LAB_OCURRENCIA.CUPO%TYPE, P_START_DATE text, P_END_DATE text, P_DAYS text) RETURNS bigint AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION david.fc_is_available_lab ( P_ROOM_ID DAVID.LAB_OCURRENCIA.ID_AMBIENTE%TYPE, P_QUOTA DAVID.LAB_OCURRENCIA.CUPO%TYPE, P_START_DATE text, P_END_DATE text, P_DAYS text) FROM PUBLIC;
