...
CREATE OR REPLACE FUNCTION david.ft_graduado_plan_old (p_id_persona integer,p_id_plan_programa integer) RETURNS bigint AS $body$
DECLARE
...
BEGIN
    ...
    and NOT EXISTS (SELECT 1
                ...
                AND ACA.ID_TIPO_CONDICION IN (1,7,13,17) AND ACA.ESTADO='1'
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION david.ft_graduado_plan_old (p_id_persona integer,p_id_plan_programa integer) FROM PUBLIC;
