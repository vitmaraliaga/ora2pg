...
CREATE OR REPLACE FUNCTION david.ft_new_users2 (v_id_persona bigint, v_opcion bigint) RETURNS varchar AS $body$
DECLARE
...
sintilde_con_punto(lower(CASE WHEN position(' ' in p.nombres)='0' THEN p.nombres  ELSE substr(p.nombres,0,position(' ' in p.nombres)-1) END ||'.'||substr(p.paterno,0,1)||'.'||p.materno))||round(dbms_random.value(1, 9))/*5*/
 END ,
    ...
    left join eliseo.users u2 on u2.email=CASE WHEN coalesce(u.email::text, '') = '' THEN sintilde_con_punto(lower(CASE WHEN position(' ' in p.nombres)='0' THEN p.nombres  ELSE substr(p.nombres,0,position(' ' in p.nombres)-1) END ||'.'||p.paterno))  ELSE sintilde_con_punto(lower(CASE WHEN position(' ' in p.nombres)='0' THEN p.nombres  ELSE substr(p.nombres,0,position(' ' in p.nombres)-1) END ||'.'||p.paterno||'.'||SUBSTR(p.paterno,0,1))) END 

    left join eliseo.users u3 on u3.email=CASE WHEN coalesce(u2.email::text, '') = '' THEN  CASE WHEN coalesce(u.email::text, '') = '' THEN sintilde_con_punto(lower(CASE WHEN position(' ' in p.nombres)='0' THEN p.nombres  ELSE substr(p.nombres,0,position(' ' in p.nombres)-1) END ||'.'||p.paterno))  ELSE sintilde_con_punto(lower(CASE WHEN position(' ' in p.nombres)='0' THEN p.nombres  ELSE substr(p.nombres,0,position(' ' in p.nombres)-1) END ||'.'||p.paterno||'.'||SUBSTR(p.paterno,0,1))) END   ELSE sintilde_con_punto(replace(lower(CASE WHEN position(' ' in p.nombres)='0' THEN p.nombres  ELSE substr(p.nombres,position(' ' in p.nombres)+1) END ||'.'||p.paterno),' ','')) END 

    left join eliseo.users u4 on u4.email=CASE WHEN coalesce(u3.email::text, '') = '' THEN  CASE WHEN coalesce(u2.email::text, '') = '' THEN  CASE WHEN coalesce(u.email::text, '') = '' THEN sintilde_con_punto(lower(CASE WHEN position(' ' in p.nombres)='0' THEN p.nombres  ELSE substr(p.nombres,0,position(' ' in p.nombres)-1) END ||'.'||p.paterno))  ELSE sintilde_con_punto(lower(CASE WHEN position(' ' in p.nombres)='0' THEN p.nombres  ELSE substr(p.nombres,0,position(' ' in p.nombres)-1) END ||'.'||p.paterno||'.'||SUBSTR(p.paterno,0,1))) END   ELSE sintilde_con_punto(replace(lower(CASE WHEN position(' ' in p.nombres)='0' THEN p.nombres  ELSE substr(p.nombres,position(' ' in p.nombres)+1) END ||'.'||p.paterno),' ','')) END   ELSE sintilde_con_punto(lower(CASE WHEN position(' ' in p.nombres)='0' THEN p.nombres  ELSE substr(p.nombres,0,position(' ' in p.nombres)-1) END ||'.'||substr(p.paterno,0,1)||'.'||p.materno)) END 
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION david.ft_new_users2 (v_id_persona bigint, v_opcion bigint) FROM PUBLIC;
