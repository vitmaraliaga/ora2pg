...
CREATE OR REPLACE FUNCTION david.ft_cursos_desa_plan_old (p_id_persona integer,p_id_plan_programa integer,p_cantidad integer) RETURNS bigint AS $body$
DECLARE
...
union
              ...
              where id_plan=p_plan) alias20 
          group by Id_Plan_Curso,ciclo,curso) alias21 
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION david.ft_cursos_desa_plan_old (p_id_persona integer,p_id_plan_programa integer,p_cantidad integer) FROM PUBLIC;
