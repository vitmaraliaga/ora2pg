...
CREATE OR REPLACE FUNCTION david.ins_seccion_n (p_id_seccion text, p_identificador bigint ,p_id_ejecucion bigint) RETURNS bigint AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION david.ins_seccion_n (p_id_seccion text, p_identificador bigint ,p_id_ejecucion bigint) FROM PUBLIC;
