...
CREATE OR REPLACE FUNCTION david.ft_anular_contrato_n (p_id_alumno_contrato integer) RETURNS varchar AS $body$
DECLARE
...
BEGIN
  ...
  delete FROM ACAD_DELEGADO where id_curso_alumno in (
...
LANGUAGE PLPGSQL
;
-- REVOKE ALL ON FUNCTION david.ft_anular_contrato_n (p_id_alumno_contrato integer) FROM PUBLIC;
