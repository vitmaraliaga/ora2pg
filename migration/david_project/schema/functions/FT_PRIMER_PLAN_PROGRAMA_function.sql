...
CREATE OR REPLACE FUNCTION david.ft_primer_plan_programa (v_id_persona bigint,v_id_plan_programa bigint) RETURNS integer AS $body$
DECLARE
...
BEGIN
select min(Cpp.Id_Plan_Programa) into STRICT p_res
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION david.ft_primer_plan_programa (v_id_persona bigint,v_id_plan_programa bigint) FROM PUBLIC;
