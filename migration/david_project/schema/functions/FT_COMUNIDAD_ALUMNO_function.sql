...
CREATE OR REPLACE FUNCTION david.ft_comunidad_alumno (V_ID_PERSONA integer) RETURNS varchar AS $body$
DECLARE

p_direccion varchar(4000);

BEGIN

SELECT max(direccion) into STRICT p_direccion
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION david.ft_comunidad_alumno (V_ID_PERSONA integer) FROM PUBLIC;
