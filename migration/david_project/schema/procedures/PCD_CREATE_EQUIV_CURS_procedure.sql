...
CREATE OR REPLACE PROCEDURE david.pcd_create_equiv_curs () AS $body$
BEGIN
  insert into ACAD_CURSO_EQUIVALENCIA(ID_CURSO_DETALLE,ESTADO,ID_USUARIO_REG,FECHA_REGISTRO)
  SELECT ID_CURSO_DETALLE,1 ESTADO,23 ID_USUARIO_REG,clock_timestamp() FECHA_REGISTRO 
  ...
  SELECT b.ID_CURSO_EQUIVALENCIA,a.ID_CURSO_DETALLE,1 ESTADO,23 ID_USUARIO_REG,clock_timestamp() FECHA_REGISTRO 
...
LANGUAGE PLPGSQL
;
-- REVOKE ALL ON PROCEDURE david.pcd_create_equiv_curs () FROM PUBLIC;
