...
CREATE OR REPLACE PROCEDURE david.sp_table_columns (P_SCHEMA text, P_COLUMN text, P_VALOR text, OUT CURSOR REFCURSOR) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE david.sp_table_columns (P_SCHEMA text, P_COLUMN text, P_VALOR text, OUT CURSOR REFCURSOR) FROM PUBLIC;
