...
CREATE OR REPLACE PROCEDURE david.pcd_alumno_ciclo (p_id_semestre integer) AS $body$
DECLARE
...
LANGUAGE PLPGSQL
;
-- REVOKE ALL ON PROCEDURE david.pcd_alumno_ciclo (p_id_semestre integer) FROM PUBLIC;
