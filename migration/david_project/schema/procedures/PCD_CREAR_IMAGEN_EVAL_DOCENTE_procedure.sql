...
CREATE OR REPLACE PROCEDURE david.pcd_crear_imagen_eval_docente ( p_id_semestre text, p_id_sede text, p_id_nivel_ensenanza text, p_id_persona_reg text ) AS $body$
DECLARE
...
LANGUAGE PLPGSQL
;
-- REVOKE ALL ON PROCEDURE david.pcd_crear_imagen_eval_docente ( p_id_semestre text, p_id_sede text, p_id_nivel_ensenanza text, p_id_persona_reg text ) FROM PUBLIC;
