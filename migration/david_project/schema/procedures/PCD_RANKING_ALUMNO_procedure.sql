...
CREATE OR REPLACE PROCEDURE david.pcd_ranking_alumno (p_id_semestre integer) AS $body$
BEGIN
...
LANGUAGE PLPGSQL
;
-- REVOKE ALL ON PROCEDURE david.pcd_ranking_alumno (p_id_semestre integer) FROM PUBLIC;
