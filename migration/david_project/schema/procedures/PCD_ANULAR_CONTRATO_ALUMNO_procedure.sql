...
CREATE OR REPLACE PROCEDURE david.pcd_anular_contrato_alumno (p_id_alumno_contrato integer) AS $body$
DECLARE
...
BEGIN 
    ...
    delete FROM eliseo.VENTA_DETALLE where id_alumno_contrato=p_id_alumno_contrato;
  commit;
...
LANGUAGE PLPGSQL
;
-- REVOKE ALL ON PROCEDURE david.pcd_anular_contrato_alumno (p_id_alumno_contrato integer) FROM PUBLIC;
