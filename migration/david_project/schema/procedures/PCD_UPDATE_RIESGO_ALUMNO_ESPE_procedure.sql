...
CREATE OR REPLACE PROCEDURE david.pcd_update_riesgo_alumno_espe (val integer) AS $body$
DECLARE
...
LANGUAGE PLPGSQL
;
-- REVOKE ALL ON PROCEDURE david.pcd_update_riesgo_alumno_espe (val integer) FROM PUBLIC;
