...
CREATE OR REPLACE PROCEDURE david.sp_table_columns_n (P_COLUMN text, P_VALOR text, OUT CURSOR REFCURSOR) AS $body$
DECLARE
...
LANGUAGE PLPGSQL
;
-- REVOKE ALL ON PROCEDURE david.sp_table_columns_n (P_COLUMN text, P_VALOR text, OUT CURSOR REFCURSOR) FROM PUBLIC;
