...
CREATE OR REPLACE PROCEDURE david.pcd_cerrar_semestre_prog (p_id_semestre_programa integer) AS $body$
DECLARE
...
LANGUAGE PLPGSQL
;
-- REVOKE ALL ON PROCEDURE david.pcd_cerrar_semestre_prog (p_id_semestre_programa integer) FROM PUBLIC;
