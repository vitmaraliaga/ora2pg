...
CREATE OR REPLACE PROCEDURE david.pcd_create_alumno_admision_nc ( V_ID_TIPO_DOCUMENTO integer, V_NUM_DOCUMENTO text, V_NOMBRE text, V_PATERNO text, V_MATERNO text, V_ESTADO_CIVIL text, V_NACIONALIDAD text, V_UBIGEO integer, V_COD_RELIGION text, V_SEXO text, V_FECHA_NACIMIENTO timestamp(0), V_CELULAR text, V_CORREO text, V_ID_PLAN_PROGRAMA integer, V_ID_TIPO_BECA_ESTATAL integer, V_CONVOCATORIA text ) AS $body$
DECLARE
...
LANGUAGE PLPGSQL
;
-- REVOKE ALL ON PROCEDURE david.pcd_create_alumno_admision_nc ( V_ID_TIPO_DOCUMENTO integer, V_NUM_DOCUMENTO text, V_NOMBRE text, V_PATERNO text, V_MATERNO text, V_ESTADO_CIVIL text, V_NACIONALIDAD text, V_UBIGEO integer, V_COD_RELIGION text, V_SEXO text, V_FECHA_NACIMIENTO timestamp(0), V_CELULAR text, V_CORREO text, V_ID_PLAN_PROGRAMA integer, V_ID_TIPO_BECA_ESTATAL integer, V_CONVOCATORIA text ) FROM PUBLIC;
