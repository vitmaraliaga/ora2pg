...
CREATE OR REPLACE PROCEDURE david.pcd_create_carga_curso_unico (p_id_semestre_programa integer,p_id_plan_curso integer, p_id_usuario_reg integer, p_id_curso_modo integer, p_grupo integer default NULL, out CURSOR REFCURSOR) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE david.pcd_create_carga_curso_unico (p_id_semestre_programa integer,p_id_plan_curso integer, p_id_usuario_reg integer, p_id_curso_modo integer, p_grupo integer default NULL, out CURSOR REFCURSOR) FROM PUBLIC;
