...
pi.ID_PERSONA_INTERES,pi.ID_PERSONA,coalesce(pi.ID_PROGRAMA_ESTUDIO,0)  ,pi.ID_CANAL_DETALLE,pi.ID_CLASIFICACION,pi.ID_CONVOCATORIA_DETALLE,pi.ESTADO,pi.ID_USUARIO_REG,pi.FECHA_REGISTRO,pi.ID_USUARIO_ACT,pi.FECHA_ACTUALIZACION,
...
tp.id_tipo_prioridad, coalesce(tp.nombre, '-') prioridad_nombre, coalesce(tp.orden,0) prioridad_orden,
coalesce(cdt.valor, 'Sin canal de referencia') canal_detalle_valor, coalesce(cdt.id_canal::text, '') id_canal,
coalesce(tc2.NOMBRE , 'Sin campaña')
