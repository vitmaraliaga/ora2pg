...
dbms_output.put_line('		 CORRELATIVO  : '||L_CORRELATIVO);
   ...
   PROCEDURE SP_ACTUALIZAR_TOTALIMP_COMPRA(P_ID_COMPRA NUMBER) IS
    ...
    BEGIN
        ...
        IF P_ERROR = 0 THEN
            SELECT ID_ENTIDAD,ID_PROVEEDOR,SERIE,NUMERO,BASE,IGV,IMPORTE,IMPORTE_ME,ESTADO INTO L_ID_ENTIDAD,L_ID_PROVEEDOR,L_SERIE,L_NUMERO,L_BASE, L_IGV, L_IMPORTE, L_IMPORTE_ME, L_ESTADO  FROM COMPRA WHERE ID_COMPRA = P_ID_COMPRA;
            IF L_ESTADO <> '1' THEN
