...
PROCEDURE        SPC_SALDO_ALUMNO (P_ID_ENTIDAD NUMBER, P_ID_DEPTO VARCHAR2, P_ID_ANHO NUMBER, P_ID_MES NUMBER, CURSOR OUT SYS_REFCURSOR)IS
    L_ID_MES NUMBER; 
    L_ID_MESES NUMBER;
    L_ID_CLIENTE NUMBER; 
            ...
            WHILE L_MES%FOUND LOOP
                ...
                BEGIN
                    SELECT 
                           ...
                           INTO L_ID_CLIENTE,L_ID_MESES,L_INGRESO,L_DEBITO,L_CREDITO,L_SALDO
                ...
                IF L_SALDO = 0 OR L_DEBITO = 0 THEN
                    SELECT COUNT(1) INTO L_CANT FROM TT_SALDO_ALUMNO_MES
                    ...
                    IF L_CANT > 0 THEN
                        SELECT DEBITO,SALDO INTO L_DEBITO,L_SALDO FROM TT_SALDO_ALUMNO_MES
                        WHERE ID_ENTIDAD = P_ID_ENTIDAD AND ID_DEPTO = P_ID_DEPTO AND ID_ANHO = P_ID_ANHO AND ID_MES = L_ID_MES-1 AND ID_CLIENTE = L_ID_CLIENTE;
                    END IF;
                END IF;
