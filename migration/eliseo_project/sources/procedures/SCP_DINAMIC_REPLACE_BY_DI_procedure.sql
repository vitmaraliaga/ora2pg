...
PROCEDURE scp_dinamic_replace_by_di(
    v_ID_DINAMICA_FROM    IN NUMBER,
    v_ID_DINAMICA_TO    IN NUMBER,
    v_ERROR OUT NUMBER,
...
AS
   ...
   l_id_almacen number;
    ...
    l_id_depto_to varchar2(20);
    l_id_entidad_to number;
...
BEGIN
    ...
    IF L_ERROR = 0 THEN 
        ...
        SELECT id_depto, id_entidad into l_id_depto_to,l_id_entidad_to FROM conta_dinamica
