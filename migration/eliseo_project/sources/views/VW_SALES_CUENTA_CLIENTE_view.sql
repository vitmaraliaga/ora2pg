...
CREATE OR REPLACE VIEW vw_sales_cuenta_cliente (id_entidad, id_depto, id_venta, id_anho, id_mes, cuenta, tipo, fecha, lote, operacion, numero, total, alumno, codigo, debito, credito) AS SELECT ID_ENTIDAD,
            ...
            FECHA,
            LOTE,
            DECODE (ID_COMPROBANTE, '07', 'NOTA CREDITO', 'VENTA') AS OPERACION,
            NUMERO,
            TOTAL,
            ALUMNO,
            CODIGO,
       ...
       FROM (SELECT A.ID_ENTIDAD,
              ...
              WHERE A.ID_ENTIDAD = 7124 AND A.ID_TIPOVENTA <> 5)
   GROUP BY ID_ENTIDAD,
            ID_DEPTO,
            ID_VENTA,
            ID_ANHO,
   ...
   UNION ALL
     ...
     SELECT                                                  --ID_VENTA,FECHA,
           ID_ENTIDAD,
            ...
            FECHA,
            LOTE,
            DECODE (ID_COMPROBANTE, '07', 'NOTA CREDITO', 'TRANSFERENCIA')
               AS OPERACION,
            NUMERO,
            TOTAL,
            ALUMNO,
   ...
   UNION ALL
     ...
     SELECT ID_ENTIDAD,
            ...
            FECHA,
            LOTE,
            DECODE (ID_MEDIOPAGO, '08', 'EFECTIVO', 'BANCO/VISA') AS OPERACION,
            NUMERO,
            IMPORTE,
            ALUMNO,
            CODIGO,
