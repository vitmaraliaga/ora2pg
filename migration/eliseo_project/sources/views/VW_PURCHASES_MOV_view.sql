...
CREATE OR REPLACE VIEW vw_purchases_mov (id_entidad, id_depto, id_anho, id_mes, id_compra, id_proveedor, id_comprobante, id_moneda, id_tipoorigen, id_origen, id_voucher, serie, numero, nro_referencia, fecha_doc, fecha_provision, importe, importe_me, importe_doc, correlativo, id_persona, oper, tipocambio) AS SELECT A.ID_ENTIDAD,
        A.ID_DEPTO,
        A.ID_ANHO,
        A.ID_MES,
        A.ID_COMPRA,
        ...
        A.TIPOCAMBIO
  FROM COMPRA A
  WHERE A.ID_COMPROBANTE NOT IN ('07','08','87')
  AND A.ESTADO = '1'
  UNION ALL
  SELECT A.ID_ENTIDAD,
      A.ID_DEPTO,
...
SELECT A.ID_ENTIDAD,
      ...
      C.CORRELATIVO,
      A.ID_USER,
      DECODE(A.ID_MEDIOPAGO,'001','TLC.-','007','CHQ.-','008','EFE.-')||A.NUMERO AS OPER,
      NULL AS TIPOCAMBIO
...
SELECT 
        ...
        A.ID_MES,
        --B.ID_COMPRA,
        NVL((SELECT ID_SALDO FROM COMPRA_SALDO X WHERE B.ID_COMPRA = X.ID_COMPRA  AND A.ID_ANHO = X.ID_ANHO AND A.ID_PROVEEDOR = X.ID_PROVEEDOR),B.ID_COMPRA) AS ID_COMPRA,
        A.ID_PROVEEDOR,
        B.ID_COMPROBANTE,
        A.ID_MONEDA,
        A.ID_TIPOORIGEN,
        ...
        A.IMPORTE * DECODE(A.ID_COMPROBANTE,'08',1,-1) AS IMPORTE,
        A.IMPORTE_ME * DECODE(A.ID_COMPROBANTE,'08',1,-1) AS IMPORTE_ME,
        0 as IMPORTE_DOC,
        A.CORRELATIVO,
        A.ID_PERSONA,
        DECODE(A.ID_COMPROBANTE,'07','N/C.-','08','N/D.-')||A.NUMERO AS OPER,
        A.TIPOCAMBIO
...
WHERE A.ID_PARENT = B.ID_SALDO AND A.ID_PROVEEDOR = B.ID_PROVEEDOR
AND A.ID_COMPROBANTE IN ('07','08','87')
AND A.ESTADO = '1';
