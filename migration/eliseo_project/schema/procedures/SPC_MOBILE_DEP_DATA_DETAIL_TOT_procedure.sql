...
CREATE OR REPLACE PROCEDURE eliseo.spc_mobile_dep_data_detail_tot ( p_id_entidad integer, p_id_anho integer, p_id_depto integer, OUT CURSOR REFCURSOR ) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE eliseo.spc_mobile_dep_data_detail_tot ( p_id_entidad integer, p_id_anho integer, p_id_depto integer, OUT CURSOR REFCURSOR ) FROM PUBLIC;
