...
CREATE OR REPLACE PROCEDURE eliseo.sp_venta_bolsa (P_ID_MOV_VNT text) AS $body$
DECLARE

S_GRAVADA decimal(10,2);
S_IGV decimal(10,2);
S_OTROS_CARGOS decimal(10,2);
...
SELECT SUM(BASE) BASE, SUM(IGV) IGV, SUM(OTROS_CARGOS) OTROS_CARGOS INTO STRICT S_GRAVADA,S_IGV, S_OTROS_CARGOS
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE eliseo.sp_venta_bolsa (P_ID_MOV_VNT text) FROM PUBLIC;
