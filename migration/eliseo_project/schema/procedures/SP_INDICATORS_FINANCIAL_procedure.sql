...
CREATE OR REPLACE PROCEDURE eliseo.sp_indicators_financial (P_ENTIDAD integer, P_ANHO integer,P_MES integer,P_DATA OUT TYPES.cursor_type) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE eliseo.sp_indicators_financial (P_ENTIDAD integer, P_ANHO integer,P_MES integer,P_DATA OUT TYPES.cursor_type) FROM PUBLIC;
