...
CREATE OR REPLACE PROCEDURE eliseo.sp_markings_register ( v_year bigint, v_month bigint, v_day bigint ) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE eliseo.sp_markings_register ( v_year bigint, v_month bigint, v_day bigint ) FROM PUBLIC;
