...
CREATE OR REPLACE PROCEDURE eliseo.iudp_diario_adicional (P_Modo integer, P_ID_ENTIDAD integer, P_COD_AASI integer, P_ID_TIPOASIENTO text, P_FEC_ASIENTO text, P_FEC_DIGITADO text, P_FEC_CONTABILIZADO text, P_NOM_DIGITADOR text, P_NOM_CONTADOR text, P_COMENTARIO text) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE eliseo.iudp_diario_adicional (P_Modo integer, P_ID_ENTIDAD integer, P_COD_AASI integer, P_ID_TIPOASIENTO text, P_FEC_ASIENTO text, P_FEC_DIGITADO text, P_FEC_CONTABILIZADO text, P_NOM_DIGITADOR text, P_NOM_CONTADOR text, P_COMENTARIO text) FROM PUBLIC;
