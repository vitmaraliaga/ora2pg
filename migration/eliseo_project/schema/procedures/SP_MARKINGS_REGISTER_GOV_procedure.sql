...
CREATE OR REPLACE PROCEDURE eliseo.sp_markings_register_gov ( v_id_entidad bigint, v_year bigint, v_month bigint ) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE eliseo.sp_markings_register_gov ( v_id_entidad bigint, v_year bigint, v_month bigint ) FROM PUBLIC;
