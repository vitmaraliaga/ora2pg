...
CREATE OR REPLACE PROCEDURE eliseo.spc_account_statement_by_id ( p_id_entidad integer, p_id_anho integer, p_id_mes integer, p_id_persona integer, p_id_cta_cte text, p_sueldo OUT bigint ) AS $body$
DECLARE
...
;
    ...
    RAISE NOTICE '%', l_descuentos;
    RAISE NOTICE 'l_descuento_extraordinario';
    RAISE NOTICE '%', l_descuento_extraordinario;
    RAISE NOTICE 'l_descuentos_ayudas';
    RAISE NOTICE '%', l_descuentos_ayudas;
    RAISE NOTICE 'l_descuentos_viajes';
    RAISE NOTICE '%', l_descuentos_viajes;
    RAISE NOTICE 'l_descuentos_adelantos';
    RAISE NOTICE '%', l_descuentos_adelantos;


    p_sueldo := round (l_ingresos - (l_descuentos + l_descuento_extraordinario + l_descuentos_ayudas + l_descuentos_viajes+ l_descuentos_adelantos),2);
    
    --p_sueldo := l_sueldo_depositado;
    RAISE NOTICE 'sueldo';
    RAISE NOTICE '%', p_sueldo;
    RAISE NOTICE 'variable out';
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE eliseo.spc_account_statement_by_id ( p_id_entidad integer, p_id_anho integer, p_id_mes integer, p_id_persona integer, p_id_cta_cte text, p_sueldo OUT bigint ) FROM PUBLIC;
