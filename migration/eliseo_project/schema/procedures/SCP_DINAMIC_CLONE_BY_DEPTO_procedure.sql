...
CREATE OR REPLACE PROCEDURE eliseo.scp_dinamic_clone_by_depto ( v_ID_ENTIDAD bigint, v_ID_YEAR bigint, v_ID_DEPTO_FROM text, v_ID_DEPTO_TO text, v_ERROR OUT bigint, v_MSGERROR OUT text ) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE eliseo.scp_dinamic_clone_by_depto ( v_ID_ENTIDAD bigint, v_ID_YEAR bigint, v_ID_DEPTO_FROM text, v_ID_DEPTO_TO text, v_ERROR OUT bigint, v_MSGERROR OUT text ) FROM PUBLIC;
