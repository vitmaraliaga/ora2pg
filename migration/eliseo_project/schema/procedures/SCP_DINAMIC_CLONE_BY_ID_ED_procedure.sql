...
CREATE OR REPLACE PROCEDURE eliseo.scp_dinamic_clone_by_id_ed ( v_ID_DINAMICA bigint, v_ID_YEAR_TO bigint, v_ID_ENTIDAD_TO bigint, v_ID_DEPTO_TO text, v_ERROR OUT bigint, v_MSGERROR OUT text ) AS $body$
DECLARE
...
BEGIN
    ...
    IF L_ERROR = 0 THEN
        ...
        LOOP
                ...
                RAISE NOTICE 'Departamento: %', v_ID_DEPTO_TO;
                ...
                RAISE NOTICE 'Paso: %', v_ID_DEPTO_TO;
                    ...
                    INSERT INTO CONTA_DINAMICA_ASIENTO(
                       ...
                       -- DBMS_OUTPUT.PUT_LINE(d_cc_record.ID_CTACTE);
                        ...
                        OPEN v_d_d_cursor FOR EXECUTE EXECUTE v_d_d_stmt_str USING d_a_record.ID_ASIENTO;
                            ...
                            RAISE NOTICE '>>>d_d_record.ID_ENTIDAD %', v_ID_ENTIDAD_TO;
                            RAISE NOTICE '>>>d_d_record.ID_DEPTO %', v_ID_DEPTO_TO;
                            RAISE NOTICE '>>>d_a_record.ID_ASIENTO %', d_a_record.ID_ASIENTO;
                            RAISE NOTICE '>>>d_a_record.ID_ASIENTO %', d_a_record.ID_ASIENTO;
                            RAISE NOTICE '>>>rec_1.ID_DINAMICA %', rec_1.ID_DINAMICA;
                            RAISE NOTICE '>>>rec_1.ID_ENTIDAD %', v_ID_ENTIDAD_TO;

                            SELECT COUNT(1) INTO STRICT l_contar FROM CONTA_ENTIDAD_DEPTO ced WHERE ID_ENTIDAD = v_ID_ENTIDAD_TO
                            ...
                            INSERT INTO CONTA_DINAMICA_ASIENTO(
                               ...
                               -- DBMS_OUTPUT.PUT_LINE(d_cc_record.ID_CTACTE);
                                ...
                                OPEN v_d_d_cursor FOR EXECUTE EXECUTE v_d_d_stmt_str USING d_a_ch_record.ID_ASIENTO;
                                    ...
                                    RAISE NOTICE '>>>v_ID_ENTIDAD %', v_ID_ENTIDAD_TO;
                                    RAISE NOTICE '>>>d_d_record.ID_ENTIDAD %', v_ID_ENTIDAD_TO;
                                    ...
                                    INSERT INTO CONTA_DINAMICA_ASIENTO(
                                       ...
                                       -- DBMS_OUTPUT.PUT_LINE(d_cc_record.ID_CTACTE);
                                        ...
                                        OPEN v_d_d_cursor FOR EXECUTE EXECUTE v_d_d_stmt_str USING d_a_ch_record.ID_ASIENTO;
                                            ...
                                            RAISE NOTICE '>>>d_a_record.ID_ASIENTO %', d_a_record.ID_ASIENTO;
                                            RAISE NOTICE '>>>rec_1.ID_DINAMICA %', rec_2.ID_DINAMICA;
                                            RAISE NOTICE '>>>v_ID_ENTIDAD_TO %', v_ID_ENTIDAD_TO;
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE eliseo.scp_dinamic_clone_by_id_ed ( v_ID_DINAMICA bigint, v_ID_YEAR_TO bigint, v_ID_ENTIDAD_TO bigint, v_ID_DEPTO_TO text, v_ERROR OUT bigint, v_MSGERROR OUT text ) FROM PUBLIC;
