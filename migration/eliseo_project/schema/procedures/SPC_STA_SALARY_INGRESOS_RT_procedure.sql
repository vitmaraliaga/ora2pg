...
CREATE OR REPLACE PROCEDURE eliseo.spc_sta_salary_ingresos_rt ( p_id_entidad integer, p_id_entidad_assinet integer, p_id_anho integer, p_id_mes integer, p_id_persona integer, p_id_ctacte text, OUT CURSOR REFCURSOR ) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE eliseo.spc_sta_salary_ingresos_rt ( p_id_entidad integer, p_id_entidad_assinet integer, p_id_anho integer, p_id_mes integer, p_id_persona integer, p_id_ctacte text, OUT CURSOR REFCURSOR ) FROM PUBLIC;
