...
CREATE OR REPLACE PROCEDURE eliseo.scp_dinamic_create ( v_ID_ENTIDAD bigint, v_ID_DEPTO text DEFAULT NULL) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE eliseo.scp_dinamic_create ( v_ID_ENTIDAD bigint, v_ID_DEPTO text DEFAULT NULL) FROM PUBLIC;
