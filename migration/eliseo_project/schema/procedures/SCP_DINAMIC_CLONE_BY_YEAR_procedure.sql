...
CREATE OR REPLACE PROCEDURE eliseo.scp_dinamic_clone_by_year ( v_ID_ENTIDAD bigint, v_ID_YEAR_TO bigint, v_ID_YEAR_FROM bigint, v_ERROR OUT bigint, v_MSGERROR OUT text ) AS $body$
DECLARE
...
BEGIN
    ...
    RAISE NOTICE 'Cantidad de dinamicas: %', l_contar;
                    ...
                    INSERT INTO CONTA_DINAMICA_ASIENTO(
                       ...
                       -- DBMS_OUTPUT.PUT_LINE(d_cc_record.ID_CTACTE);
                        ...
                        OPEN v_d_d_cursor FOR EXECUTE EXECUTE v_d_d_stmt_str USING d_a_record.ID_ASIENTO;
                            ...
                            RAISE NOTICE '>>>v_ID_ENTIDAD %', v_ID_ENTIDAD;
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE eliseo.scp_dinamic_clone_by_year ( v_ID_ENTIDAD bigint, v_ID_YEAR_TO bigint, v_ID_YEAR_FROM bigint, v_ERROR OUT bigint, v_MSGERROR OUT text ) FROM PUBLIC;
