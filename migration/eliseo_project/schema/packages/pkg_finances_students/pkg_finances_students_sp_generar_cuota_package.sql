...
union all
      ...
      */
        ...
        ---pkg_finances_students_sp_actualizar_total_venta(l_id_venta);
        --FORMA DE PAGO
        IF l_id_comprobante = '01' THEN
        ...
        if  l_codigo_mod = 'V' and l_creditosvar<0 then
            ...
            CALL pkg_finances_students_sp_generar_asiento_cuota(P_ID_ALUMNO_CONTRATO,P_ID_ENTIDAD,l_id_venta,'N',l_error,l_msgerror);
        end if;
      ...
      END IF;
        ...
        if  l_codigo_mod = 'V' and l_creditosvar<0 then
          ...
          IF L_TOTAL_ANTICIPO > 0 THEN
              ...
              END IF;
              INSERT INTO MAT_TEST_ANTICIPO(ID_PERSONA,ID_VENTA,IMPORTE,FECHA)VALUES (l_id_cliente,l_id_venta,L_IMPORTE_ANTICIPO,clock_timestamp());--PARA VER QUE VENTAS TRAE ANTICIPOS
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE eliseo.pkg_finances_students_sp_generar_cuota (P_ID_ALUMNO_CONTRATO bigint,P_ID_ENTIDAD bigint,P_ID_DEPTO text,P_ID_ANHO bigint,P_ID_MES bigint,P_ID_PERSONA bigint,P_ES_VIRTUAL text,P_ID_TIPOVENTA bigint,P_CONINTERNADO text,P_NRO_CUOTA bigint,P_ID_VENTA OUT bigint,P_ERROR OUT bigint,P_MSGERROR out text) FROM PUBLIC;
