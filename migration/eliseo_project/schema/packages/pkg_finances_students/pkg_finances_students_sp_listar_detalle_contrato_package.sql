...
CREATE OR REPLACE PROCEDURE eliseo.pkg_finances_students_sp_listar_detalle_contrato (P_ID_ALUMNO_CONTRATO bigint,P_DC text,OUT CURSOR REFCURSOR ) AS $body$
BEGIN
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE eliseo.pkg_finances_students_sp_listar_detalle_contrato (P_ID_ALUMNO_CONTRATO bigint,P_DC text,OUT CURSOR REFCURSOR ) FROM PUBLIC;
