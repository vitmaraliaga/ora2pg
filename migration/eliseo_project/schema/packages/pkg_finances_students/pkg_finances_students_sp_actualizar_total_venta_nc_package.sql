...
CREATE OR REPLACE PROCEDURE eliseo.pkg_finances_students_sp_actualizar_total_venta_nc (P_ID_VENTA bigint) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE eliseo.pkg_finances_students_sp_actualizar_total_venta_nc (P_ID_VENTA bigint) FROM PUBLIC;
