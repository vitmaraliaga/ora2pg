...
CREATE OR REPLACE PROCEDURE eliseo.pkg_finances_students_sp_generar_asiento_transf_idec (P_ID_ALUMNO_CONTRATO bigint,P_ID_TRANSFERENCIA bigint,P_ERROR OUT bigint,P_MSGERROR out text) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE eliseo.pkg_finances_students_sp_generar_asiento_transf_idec (P_ID_ALUMNO_CONTRATO bigint,P_ID_TRANSFERENCIA bigint,P_ERROR OUT bigint,P_MSGERROR out text) FROM PUBLIC;
