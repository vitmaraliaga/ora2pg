...
CREATE OR REPLACE PROCEDURE eliseo.pkg_finances_students_sp_ense_extrap_dirig (P_ID_ALUMNO_CONTRATO bigint,P_ID_CRITERIO_SEMESTRE bigint,P_TIPO_ALUMNO text,P_ERROR OUT bigint,P_MSGERROR out text) AS $body$
DECLARE
    ...
    l_criterio_proc bigint;
    l_importe_cred decimal(10,2);
...
--       goto salida_prog_dir;
    ...
    SELECT sum(CREDITO)  INTO STRICT l_creditos
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE eliseo.pkg_finances_students_sp_ense_extrap_dirig (P_ID_ALUMNO_CONTRATO bigint,P_ID_CRITERIO_SEMESTRE bigint,P_TIPO_ALUMNO text,P_ERROR OUT bigint,P_MSGERROR out text) FROM PUBLIC;
