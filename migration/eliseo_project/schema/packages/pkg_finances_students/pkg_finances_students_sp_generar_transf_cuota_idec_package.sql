...
CREATE OR REPLACE PROCEDURE eliseo.pkg_finances_students_sp_generar_transf_cuota_idec (P_ID_ALUMNO_CONTRATO bigint,P_ID_ENTIDAD bigint,P_ID_DEPTO text,P_ID_ANHO bigint,P_ID_MES bigint,P_ID_PERSONA bigint,P_NRO_CUOTA bigint,P_ID_TRANSFERENCIA OUT bigint,P_ERROR OUT bigint,P_MSGERROR out text) AS $body$
DECLARE
      ...
      l_id_dinamica bigint:= 1516; --743;--pendiente
      l_id_cliente bigint;
      l_glosa varchar(100):='';
...
--           goto salida_transf_idec_cuota;
      ...
      --pkg_sales_sp_obtener_serie_numero(P_ID_PERSONA,'00',P_ID_ENTIDAD,l_serie,l_correlativo);
...
--            goto salida_transf_idec_cuota;
      ...
      SELECT lpad(l_correlativo::text,8,'0') into STRICT l_numero;
        ...
        SELECT 
    D.NOMBRE into STRICT l_nom_nivel_ensenanza
...
--               GOTO salida_transf_idec_cuota;
       ...
       CALL pkg_finances_students_sp_gen_asto_trans_cuota_idec(P_ID_ALUMNO_CONTRATO,L_ID_TRANSFERENCIA,l_error,l_msgerror);
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE eliseo.pkg_finances_students_sp_generar_transf_cuota_idec (P_ID_ALUMNO_CONTRATO bigint,P_ID_ENTIDAD bigint,P_ID_DEPTO text,P_ID_ANHO bigint,P_ID_MES bigint,P_ID_PERSONA bigint,P_NRO_CUOTA bigint,P_ID_TRANSFERENCIA OUT bigint,P_ERROR OUT bigint,P_MSGERROR out text) FROM PUBLIC;
