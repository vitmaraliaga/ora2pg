...
CREATE OR REPLACE PROCEDURE eliseo.pkg_prof_sp_desc_especial (P_ID_PROFORMA bigint,P_ID_CRITERIO_SEMESTRE bigint,P_ERROR OUT bigint,P_MSGERROR out text) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE eliseo.pkg_prof_sp_desc_especial (P_ID_PROFORMA bigint,P_ID_CRITERIO_SEMESTRE bigint,P_ERROR OUT bigint,P_MSGERROR out text) FROM PUBLIC;
