...
CREATE OR REPLACE PROCEDURE eliseo.pkg_presupuesto_sp_gen_presupuesto_det_dist (P_ID_PRESUPUESTO bigint) AS $body$
DECLARE
...
BEGIN
      ...
      OPEN cur;
          ...
          WHILE cur%FOUND LOOP
            ...
            INTO STRICT l_id_actividad,l_tipo_dist,l_total
            ...
            select count(*) INTO STRICT l_meses from PSTO_ACTIVIDAD_DIST WHERE ID_ACTIVIDAD=l_id_actividad;
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE eliseo.pkg_presupuesto_sp_gen_presupuesto_det_dist (P_ID_PRESUPUESTO bigint) FROM PUBLIC;
