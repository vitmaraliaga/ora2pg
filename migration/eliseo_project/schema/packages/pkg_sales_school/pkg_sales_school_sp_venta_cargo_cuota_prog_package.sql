...
CREATE OR REPLACE PROCEDURE eliseo.pkg_sales_school_sp_venta_cargo_cuota_prog ( P_IMPORTE text, P_ID_ARTICULO text, P_ID_PERSONA bigint, P_ID_ENTIDAD bigint,P_ID_DEPTO text,P_ID_ANHO bigint, P_ID_MES bigint, P_FECHA timestamp(0), P_ID_CLIENTE bigint,P_ID_CLIENTE_LEGAL bigint, P_ID_COMPROBANTE text, P_ID_MONEDA bigint,  -- moneda de venta 
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE eliseo.pkg_sales_school_sp_venta_cargo_cuota_prog ( P_IMPORTE text, P_ID_ARTICULO text, P_ID_PERSONA bigint, P_ID_ENTIDAD bigint,P_ID_DEPTO text,P_ID_ANHO bigint, P_ID_MES bigint, P_FECHA timestamp(0), P_ID_CLIENTE bigint,P_ID_CLIENTE_LEGAL bigint, P_ID_COMPROBANTE text, P_ID_MONEDA bigint, P_ID_VENTA OUT bigint, P_ERROR OUT bigint,P_MSGERROR OUT text) FROM PUBLIC;
