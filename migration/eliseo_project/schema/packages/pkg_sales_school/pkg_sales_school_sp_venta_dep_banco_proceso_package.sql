...
CREATE OR REPLACE PROCEDURE eliseo.pkg_sales_school_sp_venta_dep_banco_proceso ( P_IDS_VENTA text, P_IMPORTES text, P_IDS_ARTICULOS text, P_ID_PERSONA bigint, P_ID_ENTIDAD bigint,P_ID_DEPTO text,P_ID_ANHO bigint, P_ID_MES bigint,P_ID_CLIENTE bigint,P_ID_CLIENTE_LEGAL bigint, P_ID_COMPROBANTE text, P_EFECTIVO bigint, P_TARJETA bigint, P_IMPORTE_TRANS bigint,---
 P_ID_TIPO_TARJETA bigint, P_ID_CTABANCARIA bigint, ---
 P_OPERACION text, P_FECHA_OP timestamp(0),  ---
 P_ID_MONEDA bigint,  -- moneda de venta y recibo de caja
 P_ID_DEPOSITO_EFECTIVO OUT bigint, P_ID_DEPOSITO_TARJETA OUT bigint, P_ID_DEPOSITO_TRANS OUT bigint, --
 P_ID_VENTA OUT bigint, P_COUNT_ID_VENTA_OLD OUT bigint, P_ERROR OUT bigint,P_MSGERROR OUT text) AS $body$
DECLARE

        L_ID_DEPOSITO_EFECTIVO bigint:=0;
        L_ID_DEPOSITO_TARJETA bigint:=0;
        L_ID_DEPOSITO_TRANS bigint:=0;
        L_IMPORTE_DEPOSITO_EFECTIVO bigint:=0;
        L_IMPORTE_DEPOSITO_TARJETA bigint:=0;
        L_IMPORTE_DEPOSITO_TRANS bigint:=0;
...
--                 GOTO salida_rapida;
        ...
        then 
            ...
            pkg_caja_school_sp_iniciar_deposito(L_ID_DEPOSITO_TRANS, P_ID_ENTIDAD,P_ID_DEPTO,P_ID_ANHO,P_ID_MES,l_id_mediopago,P_ID_PERSONA,
...
--                 goto salida_rapida;
            ...
            THEN 
                -- AGREGAR LA VENTA CON EL IMPORTE DEL RESTO
                select s_id_venta::text,l_importe_resto::text into STRICT l_ventas,l_imp_ventas;
                pkg_caja_school_sp_crear_deposito_detalle(L_ID_DEPOSITO_TRANS,l_ventas,l_imp_ventas,s_id_articulo,l_id_moneda,l_tipocambio,l_id_dinamica,l_error,l_msgerror);
                if l_error = 1 then 
--                     GOTO salida_rapida;
                end if;
...
--             <<end_loop>>
        ...
        IF L_ID_DEPOSITO_TRANS <> 0 THEN 
            pkg_caja_school_sp_finalizar_deposito(L_ID_DEPOSITO_TRANS,l_id_dinamica,l_id_dinamica_cli_sal_ini,L_ID_CTABANCARIA,
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE eliseo.pkg_sales_school_sp_venta_dep_banco_proceso ( P_IDS_VENTA text, P_IMPORTES text, P_IDS_ARTICULOS text, P_ID_PERSONA bigint, P_ID_ENTIDAD bigint,P_ID_DEPTO text,P_ID_ANHO bigint, P_ID_MES bigint,P_ID_CLIENTE bigint,P_ID_CLIENTE_LEGAL bigint, P_ID_COMPROBANTE text, P_EFECTIVO bigint, P_TARJETA bigint, P_IMPORTE_TRANS bigint, P_ID_TIPO_TARJETA bigint, P_ID_CTABANCARIA bigint, P_OPERACION text, P_FECHA_OP timestamp(0), P_ID_MONEDA bigint, P_ID_DEPOSITO_EFECTIVO OUT bigint, P_ID_DEPOSITO_TARJETA OUT bigint, P_ID_DEPOSITO_TRANS OUT bigint, P_ID_VENTA OUT bigint, P_COUNT_ID_VENTA_OLD OUT bigint, P_ERROR OUT bigint,P_MSGERROR OUT text) FROM PUBLIC;
