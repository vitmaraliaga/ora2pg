...
CREATE OR REPLACE PROCEDURE eliseo.pkg_sales_school_sp_serv_creact_venta (P_ID_PERSONA bigint,P_ID_ENTIDAD bigint,P_ID_DEPTO text,P_ID_ANHO bigint,P_ID_MES bigint, P_ID_CLIENTE bigint,P_ID_CLIENTE_LEGAL bigint,P_ID_COMPROBANTE text, P_ID_MONEDA bigint,  -- moneda de venta 
 P_ID_VENTA INOUT bigint,P_ERROR OUT bigint,P_MSGERROR OUT text) AS $body$
DECLARE
