...
CREATE OR REPLACE PROCEDURE eliseo.pkg_sales_school_sp_venta_deposito_proceso ( P_IDS_VENTA text, P_IMPORTES text, P_IDS_ARTICULOS text, P_ID_PERSONA bigint, P_ID_ENTIDAD bigint,P_ID_DEPTO text,P_ID_ANHO bigint, P_ID_MES bigint,P_ID_CLIENTE bigint,P_ID_CLIENTE_LEGAL bigint, P_ID_COMPROBANTE text, P_EFECTIVO bigint, P_TARJETA bigint, P_ID_TIPO_TARJETA bigint, P_OPERACION text, P_ID_MONEDA bigint,  -- moneda de venta y recibo de caja
 P_ID_DEPOSITO_EFECTIVO OUT bigint, P_ID_DEPOSITO_TARJETA OUT bigint, P_ID_VENTA OUT bigint, P_COUNT_ID_VENTA_OLD OUT bigint, P_ERROR OUT bigint,P_MSGERROR OUT text) AS $body$
DECLARE
