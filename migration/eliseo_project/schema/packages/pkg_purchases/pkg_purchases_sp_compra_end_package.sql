...
SET search_path = eliseo,pkg_purchases,public;
    ...
    --
CREATE OR REPLACE PROCEDURE eliseo.pkg_purchases_sp_compra_end ( P_ID_COMPRA bigint, P_CODIGO bigint, P_ID_PERSONA bigint, P_ID_ENTIDAD bigint, P_DETALLE text, P_IP text, P_CODE OUT text, P_ERROR OUT bigint, P_MSGERROR OUT text ) AS $body$
DECLARE
        ...
        L_ID_TIPOVOUCHER bigint :=2; --Voucher de Compras
...
;
        ...
        IF L_CONT=0 THEN
            ...
            P_MSGERROR:='FINALIZAR COMPRA: Falta configuración de voucher para el asiento del periodo '||L_ID_ANHO::text;
            RETURN;
        END IF;
        ...
        ELSE
            ...
            ELSE
                SELECT
                        A.ID_VOUCHER INTO STRICT L_ID_VOUCHER
                FROM CONTA_VOUCHER A, CONTA_VOUCHER_PERSONA B
                WHERE A.ID_VOUCHER = B.ID_VOUCHER
                AND A.ID_ENTIDAD = L_ID_ENTIDAD
                AND A.ID_DEPTO = L_ID_DEPTO
        ...
        IF L_COUNT = 0 THEN
            ...
            CALL pkg_process_sp_proceso_paso_run_next(P_CODIGO,L_ID_PEDIDO,P_ID_PERSONA,P_ID_ENTIDAD,P_DETALLE,P_IP,L_ERROR,L_MSGERROR);
            --
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE eliseo.pkg_purchases_sp_compra_end ( P_ID_COMPRA bigint, P_CODIGO bigint, P_ID_PERSONA bigint, P_ID_ENTIDAD bigint, P_DETALLE text, P_IP text, P_CODE OUT text, P_ERROR OUT bigint, P_MSGERROR OUT text ) FROM PUBLIC;
