...
CREATE OR REPLACE PROCEDURE eliseo.pkg_sales_sp_insert_precios (P_ID_ALMACEN bigint,P_ID_ANHO bigint,P_ID_PARENT bigint, P_POR_VENTA bigint, P_POR_DESCUENTO bigint, P_ERROR OUT bigint,P_MSGERROR out text) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE eliseo.pkg_sales_sp_insert_precios (P_ID_ALMACEN bigint,P_ID_ANHO bigint,P_ID_PARENT bigint, P_POR_VENTA bigint, P_POR_DESCUENTO bigint, P_ERROR OUT bigint,P_MSGERROR out text) FROM PUBLIC;
