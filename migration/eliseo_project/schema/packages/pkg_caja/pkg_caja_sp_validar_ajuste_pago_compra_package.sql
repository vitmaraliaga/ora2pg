...
CREATE OR REPLACE PROCEDURE eliseo.pkg_caja_sp_validar_ajuste_pago_compra (P_ID_PAGO_COMPRA bigint, P_ID_PERSONA bigint, P_ERROR OUT bigint, P_MSGERROR OUT text) AS $body$
DECLARE
        ...
        IF l_error = 0 THEN
           ...
           IF L_ID_MONEDA_PAGO <> '7' THEN  -- Moneda extranjera
               ...
               IF L_IMPORTE_PAGO_TCC_DIF<>0 THEN
                    ...
                    CALL pkg_purchases_sp_crear_ajuste(
                    ...
                    IF l_error = 0 AND (L_ID_DINAMICA IS NOT NULL AND L_ID_DINAMICA::text <> '') THEN
                        ...
                        WHILE casi%FOUND LOOP
                            ...
                            ELSIF (L_UNICOCTACTE='X') THEN
                                SELECT pkg_purchases_fc_ruc(L_ID_PROVEEDOR_COMPRA) into STRICT L_CUENTA_CTE;
                            END IF;
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE eliseo.pkg_caja_sp_validar_ajuste_pago_compra (P_ID_PAGO_COMPRA bigint, P_ID_PERSONA bigint, P_ERROR OUT bigint, P_MSGERROR OUT text) FROM PUBLIC;
