...
CREATE OR REPLACE PROCEDURE eliseo.pkg_sales_finances_sp_saldo_ventas_clientes (P_ID_ENTIDAD bigint,P_ID_DEPTO text,P_ID_ANHO bigint,P_ID_PERSONA bigint) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE eliseo.pkg_sales_finances_sp_saldo_ventas_clientes (P_ID_ENTIDAD bigint,P_ID_DEPTO text,P_ID_ANHO bigint,P_ID_PERSONA bigint) FROM PUBLIC;
