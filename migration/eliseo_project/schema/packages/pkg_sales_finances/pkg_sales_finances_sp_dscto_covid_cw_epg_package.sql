...
CREATE OR REPLACE PROCEDURE eliseo.pkg_sales_finances_sp_dscto_covid_cw_epg (P_ID_ENTIDAD bigint,P_ID_DEPTO text,P_ERROR OUT bigint,P_MSGERROR OUT text) AS $body$
DECLARE
        ...
        AND (A.FECHA IS NOT NULL AND A.FECHA::text <> '');
                                ...
                                IF L_IMP_DSCTO > 0 THEN
                                    ...
                                    IF L_CONTAR > 0 THEN  --SI LA MATRICULA FUE UNA VENTA
                                        ...
                                        SELECT 
                                            ...
                                            INTO STRICT L_ID_PARENT,L_ID_COMPROBANTE_REF,L_SERIE_REF,L_NUMERO_REF,L_FECHA_REF
                                        FROM UPEU_REGVENTAS@DBL_ARON_APP
                                        ...
                                        --VENTA
                                        INSERT INTO FIN_CUOTA_TEST(ID_PERSONA,GLOSA,IMPORTE,VARR,NRO_CUOTA,LAMB,COVID_MAT,ID_MODALIDAD_ESTUDIO,FECHA)VALUES (L_ID_CLIENTE,L_GLOSA,L_IMP_DSCTO,L_VAR,1,'N','N',2,clock_timestamp()); --2 = 2DA ARMADA
                                    ...
                                    ELSE
                                        ...
                                        INSERT INTO FIN_SIN_DSCTO(ID_PERSONA,IMPORTE,NRO_CUOTA,LAMB,COVID_MAT,ID_MODALIDAD_ESTUDIO,FECHA)VALUES (L_ID_CLIENTE,L_IMP_DSCTO,1,'N','N',2,clock_timestamp());--2 ARMADA 2
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE eliseo.pkg_sales_finances_sp_dscto_covid_cw_epg (P_ID_ENTIDAD bigint,P_ID_DEPTO text,P_ERROR OUT bigint,P_MSGERROR OUT text) FROM PUBLIC;
