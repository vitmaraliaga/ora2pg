...
CREATE OR REPLACE PROCEDURE eliseo.pkg_sales_finances_sp_recuperacion (P_ID_ENTIDAD bigint,P_ID_DEPTO text,P_ID_ANHO bigint,P_ID_MES bigint,P_ID_USER bigint, P_ID_SEDE bigint ) AS $body$
DECLARE
...
BEGIN 
            ...
            DELETE FROM REP_RECUPERACION WHERE ID_USER = P_ID_USER;
            OPEN C_ALUMNOS;
                ...
                WHILE C_ALUMNOS%FOUND LOOP
                    ...
                    FETCH C_MESES INTO L_ID_MES;
                        WHILE C_MESES%FOUND LOOP
                            ...
                            EXCEPTION
                            WHEN OTHERS THEN
                                SELECT COUNT(1) INTO STRICT L_CANT FROM REP_RECUPERACION WHERE ID_ENTIDAD = P_ID_ENTIDAD  AND ID_DEPTO = P_ID_DEPTO AND ID_ANHO = P_ID_ANHO
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE eliseo.pkg_sales_finances_sp_recuperacion (P_ID_ENTIDAD bigint,P_ID_DEPTO text,P_ID_ANHO bigint,P_ID_MES bigint,P_ID_USER bigint, P_ID_SEDE bigint ) FROM PUBLIC;
