...
CREATE OR REPLACE PROCEDURE eliseo.pkg_payonline_sp_ventas_depositar ( P_ID_ENTIDAD bigint, P_ID_DEPTO text, P_ID_ANHO bigint, P_ID_PERSONA bigint, P_IMPORE bigint, P_VENTAS OUT text, P_VENTAS_IMP out text, P_TIPO out text ) AS $body$
DECLARE
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE eliseo.pkg_payonline_sp_ventas_depositar ( P_ID_ENTIDAD bigint, P_ID_DEPTO text, P_ID_ANHO bigint, P_ID_PERSONA bigint, P_IMPORE bigint, P_VENTAS OUT text, P_VENTAS_IMP out text, P_TIPO out text ) FROM PUBLIC;
