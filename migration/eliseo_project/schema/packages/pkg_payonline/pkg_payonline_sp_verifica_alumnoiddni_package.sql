...
;
        ...
        CALL pkg_payonline_sp_valida_dep_alumnoiddni(P_ID_ENTIDAD,P_ID_DEPTO,l_id_dinamica,P_ID_COMPROBANTE,l_id_anho,l_id_mes,l_id_user, l_error,l_msgerror);
