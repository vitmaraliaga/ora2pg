...
CREATE OR REPLACE PROCEDURE eliseo.pkg_pay_sp_deposito_diverso (P_ID_ORDEN bigint,P_IMPORTE bigint,P_IP text,P_ID OUT text,P_ERROR OUT bigint,P_MSGERROR out text) AS $body$
DECLARE
...
--               GOTO salida_depalumniddni;
        ...
        SELECT ID_TIPOTRANSACCION INTO STRICT l_id_tipotransaccion FROM CONTA_DINAMICA WHERE ID_DINAMICA=P_ID_DINAMICA;

        CALL pkg_pay_sp_crear_deposito_diverso(
                              P_ID_ENTIDAD,
                              P_ID_DEPTO,
                              l_id_anho,
                              l_id_mes,
...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE eliseo.pkg_pay_sp_deposito_diverso (P_ID_ORDEN bigint,P_IMPORTE bigint,P_IP text,P_ID OUT text,P_ERROR OUT bigint,P_MSGERROR out text) FROM PUBLIC;
