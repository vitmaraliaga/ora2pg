...
SECURITY DEFINER
;
-- REVOKE ALL ON PROCEDURE eliseo.pkg_sales_sehs_sp_iupd_venta ( P_ID_PERSONA bigint,P_ID_CLIENTE bigint,P_ID_ENTIDAD bigint, P_ID_DEPTO text,P_ID_ANHO bigint,P_ID_MES bigint, P_ID_COMPROBANTE text,P_ID_MONEDA bigint, P_ES_AUTOENTREGA bigint,P_ID_VENTA INOUT bigint, P_ERROR OUT bigint,P_MSGERROR out text) FROM PUBLIC;
