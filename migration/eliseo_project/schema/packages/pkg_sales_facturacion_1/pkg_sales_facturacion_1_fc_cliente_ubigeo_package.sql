...
CREATE OR REPLACE FUNCTION eliseo.pkg_sales_facturacion_1_fc_cliente_ubigeo ( P_ID_PERSONA bigint, P_TIPO bigint DEFAULT 4 --1=DISTRITO;2=PROVINCIA;3=DEPARTAMENTO;4=UBIGEO COMPLETO
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION eliseo.pkg_sales_facturacion_1_fc_cliente_ubigeo ( P_ID_PERSONA bigint, P_TIPO bigint DEFAULT 4 ) FROM PUBLIC;
