...
CREATE OR REPLACE VIEW vw_sales_mov (id_entidad, id_depto, id_anho, id_mes, id_venta, id_cliente, id_sucursal, id_comprobante, id_moneda, serie, numero, fecha, glosa, total, total_me, id_tipotransaccion, id_tipoventa, tipo, mov, voucher, lote, tipo_documento, numero_legal) AS SELECT 	  A.ID_ENTIDAD,
          A.ID_DEPTO,
          A.ID_ANHO,
          A.ID_MES,
          A.ID_VENTA,
