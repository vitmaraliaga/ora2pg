...
CREATE OR REPLACE VIEW x_vw_sales_detail_saldo_col_an (id_entidad, id_depto, id_anho, id_venta, id_articulo, id_cliente, id_sucursal, serie, numero, importe, importe_me, debe, haber) AS SELECT
	...
	FROM X_VW_SALES_DETAIL_MOV_COL_ANT 
