...
CREATE OR REPLACE FUNCTION eliseo.fc_psto_tipocontrato (P_ID_CARGO_PROCESO bigint) RETURNS varchar AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION eliseo.fc_psto_tipocontrato (P_ID_CARGO_PROCESO bigint) FROM PUBLIC;
