...
CREATE OR REPLACE PROCEDURE caleb.pcd_postulante_inscrito (p_id_perosona_inscripcion integer) AS $body$
DECLARE
...
LANGUAGE PLPGSQL
;
-- REVOKE ALL ON PROCEDURE caleb.pcd_postulante_inscrito (p_id_perosona_inscripcion integer) FROM PUBLIC;
