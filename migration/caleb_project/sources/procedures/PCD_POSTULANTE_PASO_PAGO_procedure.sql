...
PROCEDURE       pcd_postulante_paso_pago (p_id_perosona_inscripcion integer) IS
...
BEGIN
    ...
    if (l_id_conv_det_config is not null) THEN
        ...
        select count(pp.id_postulante_paso) INTO l_exist_paso
        from CALEB.adm_persona_inscripcion pi
        ...
        if l_exist_paso = 0 then
           ...
           values(p_id_perosona_inscripcion,l_id_conv_det_config,'1','N',sysdate);
           commit;
        end if;
