...
CREATE OR REPLACE FUNCTION moises.fc_obtener_phono (P_ID_PERSONA bigint) RETURNS varchar AS $body$
DECLARE
...
SECURITY DEFINER
 STABLE;
-- REVOKE ALL ON FUNCTION moises.fc_obtener_phono (P_ID_PERSONA bigint) FROM PUBLIC;
