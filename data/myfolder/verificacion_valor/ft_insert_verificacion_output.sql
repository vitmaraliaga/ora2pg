...
CREATE OR REPLACE FUNCTION verificacion_valor.ft_insert_verificacion ( p_id_persona integer, p_valor text, p_estado text, p_id_usuario_reg integer, p_fecha_registro timestamp(0), p_tipo text ) RETURNS refcursor AS $body$
DECLARE
...
LANGUAGE PLPGSQL
;
-- REVOKE ALL ON FUNCTION verificacion_valor.ft_insert_verificacion ( p_id_persona integer, p_valor text, p_estado text, p_id_usuario_reg integer, p_fecha_registro timestamp(0), p_tipo text ) FROM PUBLIC;
