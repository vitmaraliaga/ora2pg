...
CREATE OR REPLACE PROCEDURE registro_persona.sp_registro_persona (P_ID_PERSONA bigint,P_NOMBRE text, P_PATERNO text, P_MATERNO text,P_SEXO text,P_FEC_NACIMIENTO timestamp(0),P_ID_TIPOPAIS bigint, P_ID_TIPODOCUMENTO bigint, P_NUM_DOCUMENTO text,P_TELEFONO text, P_CELULAR text,P_CORREO text,P_ID_SITUACION_EDUCATIVO text,P_ID_TIPOESTADOCIVIL bigint,P_ES_DOCENTE CHAR, P_ERROR OUT bigint,P_MSGERROR out text,P_ID_PERSONA_NEW out bigint) AS $body$
DECLARE
...
LANGUAGE PLPGSQL
;
-- REVOKE ALL ON PROCEDURE registro_persona.sp_registro_persona (P_ID_PERSONA bigint,P_NOMBRE text, P_PATERNO text, P_MATERNO text,P_SEXO text,P_FEC_NACIMIENTO timestamp(0),P_ID_TIPOPAIS bigint, P_ID_TIPODOCUMENTO bigint, P_NUM_DOCUMENTO text,P_TELEFONO text, P_CELULAR text,P_CORREO text,P_ID_SITUACION_EDUCATIVO text,P_ID_TIPOESTADOCIVIL bigint,P_ES_DOCENTE CHAR, P_ERROR OUT bigint,P_MSGERROR out text,P_ID_PERSONA_NEW out bigint) FROM PUBLIC;
