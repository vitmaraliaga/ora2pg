...
CREATE OR REPLACE PROCEDURE registro_persona.sp_registro_docente (P_ID_PERSONA bigint,P_NOMBRE text, P_PATERNO text, P_MATERNO text, P_EMAIL out text,P_REG_DOCENTE out bigint) AS $body$
DECLARE
...
LANGUAGE PLPGSQL
;
-- REVOKE ALL ON PROCEDURE registro_persona.sp_registro_docente (P_ID_PERSONA bigint,P_NOMBRE text, P_PATERNO text, P_MATERNO text, P_EMAIL out text,P_REG_DOCENTE out bigint) FROM PUBLIC;
